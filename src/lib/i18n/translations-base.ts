export const fr = {
  ...
  pricing: {
    ...
    cmpTitle: "Comparaison détaillée",
    cmpSubtitle: "Fonctionnalités complètes par plan",
    cmpSubDesc: "Comparez chaque fonctionnalité pour choisir la formule adaptée à votre usage.",
    trialActive: "Essai actif ✓",
    planActive: "Plan actuel ✓",
    noCommitment: "Sans engagement · Résiliable à tout moment",
    capacity: "Capacité",
    annualMaxSave: "jusqu'à 240€/an",
    savePer: "Économisez {amount}€",
    toDashboard: "Accéder au dashboard →"
  },
  dashboard: {
    statsActive: "Réunions actives",
    statsActiveSub: "en ce moment",
    statsUpcoming: "Prévues",
    statsUpcomingSub: "prochaines sessions",
    statsLangs: "Langues actives",
    statsLangsSub: "simultanément",
    statsLatency: "Latence IA",
    statsLatencySub: "ms de traduction",
    instantTitle: "Réunion instantanée",
    instantDesc: "Lancez un appel vidéo multilingue en un clic. Voix naturelle, sous-titres IA, 26 langues.",
    instantCta: "Démarrer maintenant",
    scheduleTitle: "Programmer une réunion",
    scheduleDesc: "Créez un lien sécurisé, invitez vos participants et planifiez sur votre calendrier.",
    scheduleCta: "Planifier",
    joinTitle: "Rejoindre une salle",
    joinDesc: "Entrez un code de réunion ou collez un lien d'invitation.",
    joinPlaceholder: "Code de réunion",
    joinBtn: "Rejoindre",
    upcomingTitle: "Réunions à venir",
    upcomingCount: "session(s) planifiée(s)",
    viewAll: "Tout voir",
    noMeetings: "Aucune réunion planifiée",
    scheduleNow: "Programmer maintenant →",
    joinMeeting: "Rejoindre",
    featuresTitle: "Capacités de la plateforme",
    feat1Label: "Traduction vocale IA",
    feat1Desc: "26 langues, <400 ms, voix naturelle",
    feat2Label: "Transcription en direct",
    feat2Desc: "Sous-titres synchronisés en temps réel",
    feat3Label: "Enregistrement cloud",
    feat3Desc: "Stockage sécurisé, partage en un clic",
    feat4Label: "Chiffrement E2E",
    feat4Desc: "Conforme RGPD, infrastructure premium",
    feat5Label: "Résumés IA",
    feat5Desc: "Récapitulatif structuré post-réunion",
    feat6Label: "Expérience Premium",
    feat6Desc: "Interface 3D, latence ultra-faible",
    invitees: "invité(s)"
  },
  stats: {
  ...
  dash: {
    ...
    security:       "Sécurité",
    // ── Planning / Meetings page ──
    planningTitle:    "Planification & calendrier",
    planningSubtitle: "Cockpit de réunions premium.",
    creating:         "Création...",
    upcomingMtgTitle: "Réunions futures",
    upcomingSub:      "Prochains rendez-vous planifiés.",
    noUpcoming:       "Aucune réunion planifiée",
    pastMtgTitle:     "Réunions passées",
    pastSub:          "Historique des sessions.",
    noPast:           "Aucune réunion passée",
    todaySessions:    "Sessions du jour",
    estimatedGuests:  "Invités estimés",
    planForm:         "Programmer une réunion",
    planFormSub:      "Crée une session avec lien sécurisé et invités.",
    titleField:       "Titre *",
    descField:        "Description (optionnel)",
    hostField:        "Email organisateur *",
    guestsField:      "Invités : email1, email2, ...",
    scheduleBtn:      "Programmer",
    guestLink:        "Lien invité (à partager)",
    copyBtn:          "Copier",
    calendarSub:      "Sessions du jour sélectionné.",
    guestCount:       "invité(s)",
    noGuests:         "Aucun invité",
    copyGuestLink:    "Copier lien invité",
    inviteByEmail:    "Inviter par email",
    startHost:        "Démarrer (host)",
    deleteBtn:        "Supprimer",
    errTitle:         "Remplis le titre de la réunion",
    errHost:          "Remplis l'email organisateur",
    errCreating:      "Création en cours...",
    errEndAfterStart: "L'heure de fin doit être après l'heure de début",
    errDbMissing:     "Tables DB manquantes — relancer un déploiement Vercel",
    errDbRefused:     "Connexion DB refusée — vérifiez Supabase",
    errDbTimeout:     "Délai connexion DB dépassé — réessayez",
    errDuplicate:     "Une réunion avec ce lien existe déjà — réessayez",
    errCreate:        "Erreur lors de la création",
    errNetwork:       "Erreur réseau — vérifiez votre connexion",
    errHostInstant:   "Remplis l'email organisateur avant de créer une réunion",
    instantCreated:   "Réunion instantanée créée !",
    meetingCreated:   "Réunion créée avec succès !",
    meetingCreatedN:  "Réunion créée et {n} invitation(s) envoyée(s)",
    inviteFailed:     "Réunion créée, mais l'envoi des invitations a échoué",
    sendingInvites:   "Envoi des invitations...",
    invitesSent:      "Invitations envoyées !",
    inviteError:      "Erreur lors de l'envoi",
    deleting:         "Suppression...",
    meetingDeleted:   "Réunion supprimée",
    deleteError:      "Erreur lors de la suppression",
    linkCopied:       "Lien copié dans le presse-papier !",
    copyError:        "Impossible de copier le lien",
    errNetworkSimple: "Erreur réseau",
    // ── Chat page ──
    chatTitle:          "Messagerie",
    newConvo:           "Nouvelle conversation",
    channelName:        "Nom du canal *",
    channelPlaceholder: "ex: Equipe Marketing",
    create:             "Créer",
    noConvo:            "Aucune conversation.",
    noConvoSub:         "Cliquez sur + pour en créer une.",
    noMessage:          "Aucun message",
    selectOrCreate:     "Sélectionnez ou créez une conversation",
    translationActive:  "Traduction instantanée activée",
    msgPlaceholder:     "Votre message...",
    noMessages:         "Aucun message. Démarrez la conversation.",
    chatErrCreate:      "Impossible de créer la conversation.",
    chatErrUnauth:      "Connectez-vous pour accéder au chat."
  },
  guide: {
    badge:    "Guide produit",
...
export const en = {
  ...
  pricing: {
    ...
    cmpTitle: "Detailed comparison",
    cmpSubtitle: "Full features by plan",
    cmpSubDesc: "Compare each feature to choose the plan that fits your use case.",
    trialActive: "Active trial ✓",
    planActive: "Current plan ✓",
    noCommitment: "No commitment · Cancel anytime",
    capacity: "Capacity",
    annualMaxSave: "up to €240/year",
    savePer: "Save €{amount}",
    toDashboard: "Go to dashboard →"
  },
  dashboard: {
    statsActive: "Active meetings",
    statsActiveSub: "right now",
    statsUpcoming: "Upcoming",
    statsUpcomingSub: "next sessions",
    statsLangs: "Active languages",
    statsLangsSub: "simultaneously",
    statsLatency: "AI Latency",
    statsLatencySub: "ms translation",
    instantTitle: "Instant meeting",
    instantDesc: "Launch a multilingual video call in one click. Natural voice, AI subtitles, 26 languages.",
    instantCta: "Start now",
    scheduleTitle: "Schedule a meeting",
    scheduleDesc: "Create a secure link, invite your participants and schedule on your calendar.",
    scheduleCta: "Schedule",
    joinTitle: "Join a room",
    joinDesc: "Enter a meeting code or paste an invitation link.",
    joinPlaceholder: "Meeting code",
    joinBtn: "Join",
    upcomingTitle: "Upcoming meetings",
    upcomingCount: "session(s) scheduled",
    viewAll: "View all",
    noMeetings: "No meetings scheduled",
    scheduleNow: "Schedule now →",
    joinMeeting: "Join",
    featuresTitle: "Platform capabilities",
    feat1Label: "AI voice translation",
    feat1Desc: "26 languages, <400 ms, natural voice",
    feat2Label: "Live transcription",
    feat2Desc: "Synchronized subtitles in real time",
    feat3Label: "Cloud recording",
    feat3Desc: "Secure storage, share in one click",
    feat4Label: "E2E encryption",
    feat4Desc: "GDPR compliant, premium infrastructure",
    feat5Label: "AI summaries",
    feat5Desc: "Structured recap post-meeting",
    feat6Label: "Premium experience",
    feat6Desc: "3D interface, ultra-low latency",
    invitees: "attendee(s)"
  },
  stats: {
  ...
  dash: {
    ...
    security:       "Security",
    // ── Planning / Meetings page ──
    planningTitle:    "Planning & Calendar",
    planningSubtitle: "Premium meetings cockpit.",
    creating:         "Creating...",
    upcomingMtgTitle: "Upcoming meetings",
    upcomingSub:      "Next scheduled appointments.",
    noUpcoming:       "No meetings scheduled",
    pastMtgTitle:     "Past meetings",
    pastSub:          "Session history.",
    noPast:           "No past meetings",
    todaySessions:    "Today's sessions",
    estimatedGuests:  "Estimated guests",
    planForm:         "Schedule a meeting",
    planFormSub:      "Create a session with a secure link and guests.",
    titleField:       "Title *",
    descField:        "Description (optional)",
    hostField:        "Host email *",
    guestsField:      "Guests: email1, email2, ...",
    scheduleBtn:      "Schedule",
    guestLink:        "Guest link (to share)",
    copyBtn:          "Copy",
    calendarSub:      "Selected day sessions.",
    guestCount:       "guest(s)",
    noGuests:         "No guests",
    ...
    deleteBtn:        "Delete",
    errTitle:         "Please fill in the meeting title",
    errHost:          "Please fill in the host email",
    errCreating:      "Creating...",
    errEndAfterStart: "End time must be after start time",
    errDbMissing:     "DB tables missing — relaunch Vercel deployment",
    errDbRefused:     "DB connection refused — check Supabase",
    errDbTimeout:     "DB connection timed out — retry",
    errDuplicate:     "A meeting with this link already exists — retry",
    errCreate:        "Error during creation",
    errNetwork:       "Network error — check your connection",
    errHostInstant:   "Please fill in the host email before creating a meeting",
    instantCreated:   "Instant meeting created!",
    meetingCreated:   "Meeting created successfully!",
    meetingCreatedN:  "Meeting created and {n} invitation(s) sent",
    inviteFailed:     "Meeting created, but invitation sending failed",
    sendingInvites:   "Sending invitations...",
    invitesSent:      "Invitations sent!",
    inviteError:      "Error sending invitations",
    deleting:         "Deleting...",
    meetingDeleted:   "Meeting deleted",
    deleteError:      "Error deleting meeting",
    linkCopied:       "Link copied to clipboard!",
    copyError:        "Unable to copy link",
    errNetworkSimple: "Network error",
    // ── Chat page ──
    chatTitle:          "Messaging",
    newConvo:           "New conversation",
    channelName:        "Channel name *",
    channelPlaceholder: "e.g. Marketing Team",
    create:             "Create",
    noConvo:            "No conversations.",
    noConvoSub:         "Click + to create one.",
    noMessage:          "No messages",
    selectOrCreate:     "Select or create a conversation",
    translationActive:  "Instant translation active",
    msgPlaceholder:     "Your message...",
    noMessages:         "No messages. Start the conversation.",
    chatErrCreate:      "Unable to create the conversation.",
    chatErrUnauth:      "Please sign in to access chat."
  },
  guide: {
    badge:    "Product Guide",
