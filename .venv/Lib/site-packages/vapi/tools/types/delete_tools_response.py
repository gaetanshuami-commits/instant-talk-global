...
update_forward_refs(DeleteToolsResponse_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(DeleteToolsResponse_Code)
...
update_forward_refs(DeleteToolsResponse_Computer)
update_forward_refs(DeleteToolsResponse_TextEditor)
update_forward_refs(DeleteToolsResponse_Query)
update_forward_refs(DeleteToolsResponse_GoogleCalendarEventCreate)
update_forward_refs(DeleteToolsResponse_GoogleSheetsRowAppend)
update_forward_refs(DeleteToolsResponse_GoogleCalendarAvailabilityCheck)
update_forward_refs(DeleteToolsResponse_SlackMessageSend)
update_forward_refs(DeleteToolsResponse_Sms)
update_forward_refs(DeleteToolsResponse_Mcp)
update_forward_refs(DeleteToolsResponse_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(DeleteToolsResponse_GohighlevelCalendarEventCreate)
update_forward_refs(DeleteToolsResponse_GohighlevelContactCreate)
