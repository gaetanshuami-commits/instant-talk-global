...
UpdateToolsResponse = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(UpdateToolsResponse_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(UpdateToolsResponse_Code)
...
update_forward_refs(UpdateToolsResponse_Computer)
update_forward_refs(UpdateToolsResponse_TextEditor)
update_forward_refs(UpdateToolsResponse_Query)
update_forward_refs(UpdateToolsResponse_GoogleCalendarEventCreate)
update_forward_refs(UpdateToolsResponse_GoogleSheetsRowAppend)
update_forward_refs(UpdateToolsResponse_GoogleCalendarAvailabilityCheck)
update_forward_refs(UpdateToolsResponse_SlackMessageSend)
update_forward_refs(UpdateToolsResponse_Sms)
update_forward_refs(UpdateToolsResponse_Mcp)
update_forward_refs(UpdateToolsResponse_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(UpdateToolsResponse_GohighlevelCalendarEventCreate)
update_forward_refs(UpdateToolsResponse_GohighlevelContactCreate)
update_forward_refs(UpdateToolsResponse_GohighlevelContactGet)
update_forward_refs(UpdateToolsResponse_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(UpdateToolsResponse_Voicemail)
