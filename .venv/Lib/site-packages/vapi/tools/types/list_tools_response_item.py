...
class ListToolsResponseItem_ApiRequest(UncheckedBaseModel):
...
class ListToolsResponseItem_Code(UncheckedBaseModel):
...
class ListToolsResponseItem_Dtmf(UncheckedBaseModel):
...
class ListToolsResponseItem_EndCall(UncheckedBaseModel):
...
class ListToolsResponseItem_Function(UncheckedBaseModel):
...
class ListToolsResponseItem_TransferCall(UncheckedBaseModel):
...
class ListToolsResponseItem_Handoff(UncheckedBaseModel):
...
class ListToolsResponseItem_Bash(UncheckedBaseModel):
...
class ListToolsResponseItem_Computer(UncheckedBaseModel):
...
class ListToolsResponseItem_TextEditor(UncheckedBaseModel):
...
class ListToolsResponseItem_Query(UncheckedBaseModel):
...
class ListToolsResponseItem_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class ListToolsResponseItem_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class ListToolsResponseItem_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class ListToolsResponseItem_SlackMessageSend(UncheckedBaseModel):
...
class ListToolsResponseItem_Sms(UncheckedBaseModel):
...
class ListToolsResponseItem_Mcp(UncheckedBaseModel):
...
class ListToolsResponseItem_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class ListToolsResponseItem_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class ListToolsResponseItem_GohighlevelContactCreate(UncheckedBaseModel):
...
class ListToolsResponseItem_GohighlevelContactGet(UncheckedBaseModel):
...
class ListToolsResponseItem_SipRequest(UncheckedBaseModel):
...
class ListToolsResponseItem_Voicemail(UncheckedBaseModel):
...
ListToolsResponseItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(ListToolsResponseItem_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(ListToolsResponseItem_Code)
update_forward_refs(ListToolsResponseItem_Dtmf)
update_forward_refs(ListToolsResponseItem_EndCall)
update_forward_refs(ListToolsResponseItem_Function)
update_forward_refs(ListToolsResponseItem_TransferCall)
update_forward_refs(ListToolsResponseItem_Handoff)
update_forward_refs(ListToolsResponseItem_Bash)
update_forward_refs(ListToolsResponseItem_Computer)
update_forward_refs(ListToolsResponseItem_TextEditor)
update_forward_refs(ListToolsResponseItem_Query)
update_forward_refs(ListToolsResponseItem_GoogleCalendarEventCreate)
update_forward_refs(ListToolsResponseItem_GoogleSheetsRowAppend)
update_forward_refs(ListToolsResponseItem_GoogleCalendarAvailabilityCheck)
update_forward_refs(ListToolsResponseItem_SlackMessageSend)
update_forward_refs(ListToolsResponseItem_Sms)
update_forward_refs(ListToolsResponseItem_Mcp)
update_forward_refs(ListToolsResponseItem_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(ListToolsResponseItem_GohighlevelCalendarEventCreate)
update_forward_refs(ListToolsResponseItem_GohighlevelContactCreate)
update_forward_refs(ListToolsResponseItem_GohighlevelContactGet)
update_forward_refs(ListToolsResponseItem_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(ListToolsResponseItem_Voicemail)
