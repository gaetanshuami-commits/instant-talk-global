...
class CreateToolsResponse_ApiRequest(UncheckedBaseModel):
...
class CreateToolsResponse_Code(UncheckedBaseModel):
...
class CreateToolsResponse_Dtmf(UncheckedBaseModel):
...
class CreateToolsResponse_EndCall(UncheckedBaseModel):
...
class CreateToolsResponse_Function(UncheckedBaseModel):
...
class CreateToolsResponse_TransferCall(UncheckedBaseModel):
...
class CreateToolsResponse_Handoff(UncheckedBaseModel):
...
class CreateToolsResponse_Bash(UncheckedBaseModel):
...
class CreateToolsResponse_Computer(UncheckedBaseModel):
...
class CreateToolsResponse_TextEditor(UncheckedBaseModel):
...
class CreateToolsResponse_Query(UncheckedBaseModel):
...
class CreateToolsResponse_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class CreateToolsResponse_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class CreateToolsResponse_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class CreateToolsResponse_SlackMessageSend(UncheckedBaseModel):
...
class CreateToolsResponse_Sms(UncheckedBaseModel):
...
class CreateToolsResponse_Mcp(UncheckedBaseModel):
...
class CreateToolsResponse_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class CreateToolsResponse_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class CreateToolsResponse_GohighlevelContactCreate(UncheckedBaseModel):
...
class CreateToolsResponse_GohighlevelContactGet(UncheckedBaseModel):
...
class CreateToolsResponse_SipRequest(UncheckedBaseModel):
...
class CreateToolsResponse_Voicemail(UncheckedBaseModel):
...
CreateToolsResponse = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(CreateToolsResponse_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(CreateToolsResponse_Code)
update_forward_refs(CreateToolsResponse_Dtmf)
update_forward_refs(CreateToolsResponse_EndCall)
update_forward_refs(CreateToolsResponse_Function)
update_forward_refs(CreateToolsResponse_TransferCall)
update_forward_refs(CreateToolsResponse_Handoff)
update_forward_refs(CreateToolsResponse_Bash)
update_forward_refs(CreateToolsResponse_Computer)
update_forward_refs(CreateToolsResponse_TextEditor)
update_forward_refs(CreateToolsResponse_Query)
update_forward_refs(CreateToolsResponse_GoogleCalendarEventCreate)
update_forward_refs(CreateToolsResponse_GoogleSheetsRowAppend)
update_forward_refs(CreateToolsResponse_GoogleCalendarAvailabilityCheck)
update_forward_refs(CreateToolsResponse_SlackMessageSend)
update_forward_refs(CreateToolsResponse_Sms)
update_forward_refs(CreateToolsResponse_Mcp)
update_forward_refs(CreateToolsResponse_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(CreateToolsResponse_GohighlevelCalendarEventCreate)
update_forward_refs(CreateToolsResponse_GohighlevelContactCreate)
update_forward_refs(CreateToolsResponse_GohighlevelContactGet)
update_forward_refs(CreateToolsResponse_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(CreateToolsResponse_Voicemail)
