...
class CallHookAssistantSpeechInterruptedDoItem_Say(UncheckedBaseModel):
...
class CallHookAssistantSpeechInterruptedDoItem_Tool(UncheckedBaseModel):
...
class CallHookAssistantSpeechInterruptedDoItem_MessageAdd(UncheckedBaseModel):
...
CallHookAssistantSpeechInterruptedDoItem = typing_extensions.Annotated[
    typing.Union[
