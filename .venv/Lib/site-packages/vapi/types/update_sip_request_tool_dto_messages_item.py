...
class UpdateSipRequestToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class UpdateSipRequestToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class UpdateSipRequestToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class UpdateSipRequestToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
UpdateSipRequestToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
