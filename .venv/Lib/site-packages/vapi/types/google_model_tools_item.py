...
class GoogleModelToolsItem_ApiRequest(UncheckedBaseModel):
...
class GoogleModelToolsItem_Bash(UncheckedBaseModel):
...
class GoogleModelToolsItem_Code(UncheckedBaseModel):
...
class GoogleModelToolsItem_Computer(UncheckedBaseModel):
...
class GoogleModelToolsItem_Dtmf(UncheckedBaseModel):
...
class GoogleModelToolsItem_EndCall(UncheckedBaseModel):
...
class GoogleModelToolsItem_Function(UncheckedBaseModel):
...
class GoogleModelToolsItem_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class GoogleModelToolsItem_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class GoogleModelToolsItem_GohighlevelContactCreate(UncheckedBaseModel):
...
class GoogleModelToolsItem_GohighlevelContactGet(UncheckedBaseModel):
...
class GoogleModelToolsItem_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class GoogleModelToolsItem_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class GoogleModelToolsItem_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class GoogleModelToolsItem_Handoff(UncheckedBaseModel):
...
class GoogleModelToolsItem_Mcp(UncheckedBaseModel):
...
class GoogleModelToolsItem_Query(UncheckedBaseModel):
...
class GoogleModelToolsItem_SlackMessageSend(UncheckedBaseModel):
...
class GoogleModelToolsItem_Sms(UncheckedBaseModel):
...
class GoogleModelToolsItem_TextEditor(UncheckedBaseModel):
...
class GoogleModelToolsItem_TransferCall(UncheckedBaseModel):
...
class GoogleModelToolsItem_SipRequest(UncheckedBaseModel):
...
class GoogleModelToolsItem_Voicemail(UncheckedBaseModel):
...
GoogleModelToolsItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(GoogleModelToolsItem_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(GoogleModelToolsItem_Bash)
update_forward_refs(GoogleModelToolsItem_Code)
update_forward_refs(GoogleModelToolsItem_Computer)
update_forward_refs(GoogleModelToolsItem_Dtmf)
update_forward_refs(GoogleModelToolsItem_EndCall)
update_forward_refs(GoogleModelToolsItem_Function)
update_forward_refs(GoogleModelToolsItem_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(GoogleModelToolsItem_GohighlevelCalendarEventCreate)
update_forward_refs(GoogleModelToolsItem_GohighlevelContactCreate)
update_forward_refs(GoogleModelToolsItem_GohighlevelContactGet)
update_forward_refs(GoogleModelToolsItem_GoogleCalendarAvailabilityCheck)
update_forward_refs(GoogleModelToolsItem_GoogleCalendarEventCreate)
update_forward_refs(GoogleModelToolsItem_GoogleSheetsRowAppend)
update_forward_refs(
    GoogleModelToolsItem_Handoff,
...
update_forward_refs(GoogleModelToolsItem_Mcp)
update_forward_refs(GoogleModelToolsItem_Query)
update_forward_refs(GoogleModelToolsItem_SlackMessageSend)
update_forward_refs(GoogleModelToolsItem_Sms)
update_forward_refs(GoogleModelToolsItem_TextEditor)
update_forward_refs(GoogleModelToolsItem_TransferCall)
update_forward_refs(GoogleModelToolsItem_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(GoogleModelToolsItem_Voicemail)
