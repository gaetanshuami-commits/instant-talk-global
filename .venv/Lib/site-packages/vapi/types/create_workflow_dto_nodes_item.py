...
class CreateWorkflowDtoNodesItem_Conversation(UncheckedBaseModel):
...
class CreateWorkflowDtoNodesItem_Tool(UncheckedBaseModel):
...
CreateWorkflowDtoNodesItem = typing_extensions.Annotated[
    typing.Union[CreateWorkflowDtoNodesItem_Conversation, CreateWorkflowDtoNodesItem_Tool],
    UnionMetadata(discriminant="type"),
]
update_forward_refs(CreateWorkflowDtoNodesItem_Conversation)
update_forward_refs(CreateWorkflowDtoNodesItem_Tool)
