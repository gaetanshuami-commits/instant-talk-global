...
class SmsToolMessagesItem_RequestStart(UncheckedBaseModel):
...
class SmsToolMessagesItem_RequestComplete(UncheckedBaseModel):
...
class SmsToolMessagesItem_RequestFailed(UncheckedBaseModel):
...
class SmsToolMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
SmsToolMessagesItem = typing_extensions.Annotated[
    typing.Union[
