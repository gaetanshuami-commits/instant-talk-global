...
class UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
