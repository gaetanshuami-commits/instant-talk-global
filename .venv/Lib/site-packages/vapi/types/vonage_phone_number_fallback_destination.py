...
class VonagePhoneNumberFallbackDestination_Number(UncheckedBaseModel):
    """
...
class VonagePhoneNumberFallbackDestination_Sip(UncheckedBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
    1. `assistantId` is not set
    2. `squadId` is not set
...
VonagePhoneNumberFallbackDestination = typing_extensions.Annotated[
    typing.Union[VonagePhoneNumberFallbackDestination_Number, VonagePhoneNumberFallbackDestination_Sip],
