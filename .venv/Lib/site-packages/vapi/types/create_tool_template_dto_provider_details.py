...
class CreateToolTemplateDtoProviderDetails_Make(UncheckedBaseModel):
...
class CreateToolTemplateDtoProviderDetails_Ghl(UncheckedBaseModel):
...
class CreateToolTemplateDtoProviderDetails_Function(UncheckedBaseModel):
...
class CreateToolTemplateDtoProviderDetails_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class CreateToolTemplateDtoProviderDetails_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class CreateToolTemplateDtoProviderDetails_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class CreateToolTemplateDtoProviderDetails_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class CreateToolTemplateDtoProviderDetails_GohighlevelContactCreate(UncheckedBaseModel):
...
class CreateToolTemplateDtoProviderDetails_GohighlevelContactGet(UncheckedBaseModel):
...
CreateToolTemplateDtoProviderDetails = typing_extensions.Annotated[
    typing.Union[
