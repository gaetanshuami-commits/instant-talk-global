...
class MakeToolMessagesItem_RequestStart(UncheckedBaseModel):
...
class MakeToolMessagesItem_RequestComplete(UncheckedBaseModel):
...
class MakeToolMessagesItem_RequestFailed(UncheckedBaseModel):
...
class MakeToolMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
MakeToolMessagesItem = typing_extensions.Annotated[
    typing.Union[
