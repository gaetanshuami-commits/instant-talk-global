...
class CreateAssistantDto(UncheckedBaseModel):
    ...
    voicemail_detection: typing_extensions.Annotated[
        typing.Optional[CreateAssistantDtoVoicemailDetection],
    ...
    client_messages: typing_extensions.Annotated[
        typing.Optional[typing.List[CreateAssistantDtoClientMessagesItem]],
    ...
    server_messages: typing_extensions.Annotated[
        typing.Optional[typing.List[CreateAssistantDtoServerMessagesItem]],
    ...
    background_sound: typing_extensions.Annotated[
        typing.Optional[CreateAssistantDtoBackgroundSound],
