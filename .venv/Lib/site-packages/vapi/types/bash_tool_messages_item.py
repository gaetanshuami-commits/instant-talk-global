...
class BashToolMessagesItem_RequestStart(UncheckedBaseModel):
...
class BashToolMessagesItem_RequestComplete(UncheckedBaseModel):
...
class BashToolMessagesItem_RequestFailed(UncheckedBaseModel):
...
class BashToolMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
BashToolMessagesItem = typing_extensions.Annotated[
    typing.Union[
