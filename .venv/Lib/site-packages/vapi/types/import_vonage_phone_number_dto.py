...
class ImportVonagePhoneNumberDto(UncheckedBaseModel):
    fallback_destination: typing_extensions.Annotated[
        typing.Optional[ImportVonagePhoneNumberDtoFallbackDestination],
    ...
    hooks: typing.Optional[typing.List[ImportVonagePhoneNumberDtoHooksItem]] = pydantic.Field(default=None)
    """
    This is the hooks that will be used for incoming calls to this phone number.
    """

    vonage_phone_number: typing_extensions.Annotated[
        str,
        FieldMetadata(alias="vonagePhoneNumber"),
        pydantic.Field(
            alias="vonagePhoneNumber", description="These are the digits of the phone number you own on your Vonage."
        ),
    ]
