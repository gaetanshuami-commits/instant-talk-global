...
class ClientInboundMessageTransferDestination_Number(UncheckedBaseModel):
    """
...
class ClientInboundMessageTransferDestination_Sip(UncheckedBaseModel):
    """
    This is the destination to transfer the call to.
    """
...
ClientInboundMessageTransferDestination = typing_extensions.Annotated[
    typing.Union[ClientInboundMessageTransferDestination_Number, ClientInboundMessageTransferDestination_Sip],
