...
class TransferHookActionDestination_Number(UncheckedBaseModel):
    """
...
class TransferHookActionDestination_Sip(UncheckedBaseModel):
    """
    This is the destination details for the transfer - can be a phone number or SIP URI
    """
...
TransferHookActionDestination = typing_extensions.Annotated[
    typing.Union[TransferHookActionDestination_Number, TransferHookActionDestination_Sip],
