...
class OutputToolMessagesItem_RequestStart(UncheckedBaseModel):
...
class OutputToolMessagesItem_RequestComplete(UncheckedBaseModel):
...
class OutputToolMessagesItem_RequestFailed(UncheckedBaseModel):
...
class OutputToolMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
OutputToolMessagesItem = typing_extensions.Annotated[
    typing.Union[
