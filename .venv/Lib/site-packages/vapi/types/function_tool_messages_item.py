...
class FunctionToolMessagesItem_RequestStart(UncheckedBaseModel):
...
class FunctionToolMessagesItem_RequestComplete(UncheckedBaseModel):
...
class FunctionToolMessagesItem_RequestFailed(UncheckedBaseModel):
...
class FunctionToolMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
FunctionToolMessagesItem = typing_extensions.Annotated[
    typing.Union[
