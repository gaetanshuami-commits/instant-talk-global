...
class EvalRunTargetAssistant(UncheckedBaseModel):
    ...
    assistant_overrides: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="assistantOverrides", description="This is the overrides that will be applied to the assistant."
        ),
    ] = None
    assistant_id: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="assistantId", description="This is the id of the assistant that will be run against the eval"
        ),
    ] = None
