...
class DtmfToolMessagesItem_RequestStart(UncheckedBaseModel):
...
class DtmfToolMessagesItem_RequestComplete(UncheckedBaseModel):
...
class DtmfToolMessagesItem_RequestFailed(UncheckedBaseModel):
...
class DtmfToolMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
DtmfToolMessagesItem = typing_extensions.Annotated[
    typing.Union[
