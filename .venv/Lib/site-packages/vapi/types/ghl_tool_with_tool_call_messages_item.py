...
class GhlToolWithToolCallMessagesItem_RequestStart(UncheckedBaseModel):
...
class GhlToolWithToolCallMessagesItem_RequestComplete(UncheckedBaseModel):
...
class GhlToolWithToolCallMessagesItem_RequestFailed(UncheckedBaseModel):
...
class GhlToolWithToolCallMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
GhlToolWithToolCallMessagesItem = typing_extensions.Annotated[
    typing.Union[
