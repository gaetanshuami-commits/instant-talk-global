...
class CallHookTranscriberEndpointedSpeechLowConfidenceDoItem_Say(UncheckedBaseModel):
    type: typing.Literal["say"] = "say"
    prompt: typing.Optional[SayHookActionPrompt] = None
    exact: typing.Optional[typing.Dict[str, typing.Any]] = None
...
class CallHookTranscriberEndpointedSpeechLowConfidenceDoItem_Tool(UncheckedBaseModel):
    type: typing.Literal["tool"] = "tool"
    tool: typing.Optional["ToolCallHookActionTool"] = None
...
class CallHookTranscriberEndpointedSpeechLowConfidenceDoItem_MessageAdd(UncheckedBaseModel):
...
CallHookTranscriberEndpointedSpeechLowConfidenceDoItem = typing_extensions.Annotated[
    typing.Union[
