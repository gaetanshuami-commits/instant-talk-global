...
class ServerMessageTransferUpdate(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ServerMessageTransferUpdatePhoneNumber],
    ...
    type: ServerMessageTransferUpdateType = pydantic.Field()
    """
    ...
    to_assistant: typing_extensions.Annotated[
        typing.Optional["CreateAssistantDto"],
        FieldMetadata(alias="toAssistant"),
        pydantic.Field(
            alias="toAssistant",
    ...
    from_assistant: typing_extensions.Annotated[
        typing.Optional["CreateAssistantDto"],
        FieldMetadata(alias="fromAssistant"),
        pydantic.Field(
            alias="fromAssistant",
    ...
    to_step_record: typing_extensions.Annotated[
        ...
        FieldMetadata(alias="toStepRecord"),
        pydantic.Field(alias="toStepRecord", description="This is the step that the conversation moved to."),
    ] = None
    from_step_record: typing_extensions.Annotated[
        typing.Optional[typing.Dict[str, typing.Any]],
        FieldMetadata(alias="fromStepRecord"),
        pydantic.Field(alias="fromStepRecord", description="This is the step that the conversation moved from. ="),
    ] = None
