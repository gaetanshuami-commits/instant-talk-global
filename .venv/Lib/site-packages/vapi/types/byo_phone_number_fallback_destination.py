...
class ByoPhoneNumberFallbackDestination_Number(UncheckedBaseModel):
    """
...
class ByoPhoneNumberFallbackDestination_Sip(UncheckedBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
    1. `assistantId` is not set
    2. `squadId` is not set
...
ByoPhoneNumberFallbackDestination = typing_extensions.Annotated[
    typing.Union[ByoPhoneNumberFallbackDestination_Number, ByoPhoneNumberFallbackDestination_Sip],
