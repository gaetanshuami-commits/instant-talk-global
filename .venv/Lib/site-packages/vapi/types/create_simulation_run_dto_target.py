...
class CreateSimulationRunDtoTarget_Assistant(UncheckedBaseModel):
    """
...
class CreateSimulationRunDtoTarget_Squad(UncheckedBaseModel):
    """
    Target to test against
    """
...
CreateSimulationRunDtoTarget = typing_extensions.Annotated[
    typing.Union[CreateSimulationRunDtoTarget_Assistant, CreateSimulationRunDtoTarget_Squad],
