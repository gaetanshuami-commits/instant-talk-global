...
class CreateAssistantDtoCredentialsItem_Anthropic(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_AnthropicBedrock(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Anyscale(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_AssemblyAi(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_AzureOpenai(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Azure(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_ByoSipTrunk(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Cerebras(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Cloudflare(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_CustomLlm(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Deepgram(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Deepinfra(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_DeepSeek(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Gcp(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Gladia(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Gohighlevel(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Google(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Groq(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_InflectionAi(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Langfuse(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Lmnt(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Make(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Openai(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Openrouter(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_PerplexityAi(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Playht(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_RimeAi(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Runpod(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_S3(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_SmallestAi(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Tavus(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_TogetherAi(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Twilio(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Vonage(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Webhook(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_CustomCredential(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Xai(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Hume(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Mistral(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Speechmatics(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_GoogleCalendarOauth2Client(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_GoogleCalendarOauth2Authorization(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_GoogleSheetsOauth2Authorization(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_SlackOauth2Authorization(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_GhlOauth2Authorization(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Inworld(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Minimax(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Wellsaid(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_Email(UncheckedBaseModel):
...
class CreateAssistantDtoCredentialsItem_SlackWebhook(UncheckedBaseModel):
...
CreateAssistantDtoCredentialsItem = typing_extensions.Annotated[
    typing.Union[
