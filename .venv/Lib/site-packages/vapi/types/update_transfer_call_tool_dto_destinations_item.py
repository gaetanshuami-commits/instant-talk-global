...
class UpdateTransferCallToolDtoDestinationsItem_Assistant(UncheckedBaseModel):
...
class UpdateTransferCallToolDtoDestinationsItem_Number(UncheckedBaseModel):
...
class UpdateTransferCallToolDtoDestinationsItem_Sip(UncheckedBaseModel):
...
UpdateTransferCallToolDtoDestinationsItem = typing_extensions.Annotated[
    typing.Union[
