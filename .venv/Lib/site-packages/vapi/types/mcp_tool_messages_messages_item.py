...
class McpToolMessagesMessagesItem_RequestStart(UncheckedBaseModel):
...
class McpToolMessagesMessagesItem_RequestComplete(UncheckedBaseModel):
...
class McpToolMessagesMessagesItem_RequestFailed(UncheckedBaseModel):
...
class McpToolMessagesMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
McpToolMessagesMessagesItem = typing_extensions.Annotated[
    typing.Union[
