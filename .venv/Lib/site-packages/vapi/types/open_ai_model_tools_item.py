...
class OpenAiModelToolsItem_ApiRequest(UncheckedBaseModel):
...
class OpenAiModelToolsItem_Bash(UncheckedBaseModel):
...
class OpenAiModelToolsItem_Code(UncheckedBaseModel):
...
class OpenAiModelToolsItem_Computer(UncheckedBaseModel):
...
class OpenAiModelToolsItem_Dtmf(UncheckedBaseModel):
...
class OpenAiModelToolsItem_EndCall(UncheckedBaseModel):
...
class OpenAiModelToolsItem_Function(UncheckedBaseModel):
...
class OpenAiModelToolsItem_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class OpenAiModelToolsItem_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class OpenAiModelToolsItem_GohighlevelContactCreate(UncheckedBaseModel):
...
class OpenAiModelToolsItem_GohighlevelContactGet(UncheckedBaseModel):
...
class OpenAiModelToolsItem_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class OpenAiModelToolsItem_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class OpenAiModelToolsItem_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class OpenAiModelToolsItem_Handoff(UncheckedBaseModel):
...
class OpenAiModelToolsItem_Mcp(UncheckedBaseModel):
...
class OpenAiModelToolsItem_Query(UncheckedBaseModel):
...
class OpenAiModelToolsItem_SlackMessageSend(UncheckedBaseModel):
...
class OpenAiModelToolsItem_Sms(UncheckedBaseModel):
...
class OpenAiModelToolsItem_TextEditor(UncheckedBaseModel):
...
class OpenAiModelToolsItem_TransferCall(UncheckedBaseModel):
...
class OpenAiModelToolsItem_SipRequest(UncheckedBaseModel):
...
class OpenAiModelToolsItem_Voicemail(UncheckedBaseModel):
...
OpenAiModelToolsItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(OpenAiModelToolsItem_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(OpenAiModelToolsItem_Bash)
update_forward_refs(OpenAiModelToolsItem_Code)
update_forward_refs(OpenAiModelToolsItem_Computer)
update_forward_refs(OpenAiModelToolsItem_Dtmf)
update_forward_refs(OpenAiModelToolsItem_EndCall)
update_forward_refs(OpenAiModelToolsItem_Function)
update_forward_refs(OpenAiModelToolsItem_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(OpenAiModelToolsItem_GohighlevelCalendarEventCreate)
update_forward_refs(OpenAiModelToolsItem_GohighlevelContactCreate)
update_forward_refs(OpenAiModelToolsItem_GohighlevelContactGet)
update_forward_refs(OpenAiModelToolsItem_GoogleCalendarAvailabilityCheck)
update_forward_refs(OpenAiModelToolsItem_GoogleCalendarEventCreate)
update_forward_refs(OpenAiModelToolsItem_GoogleSheetsRowAppend)
update_forward_refs(
    OpenAiModelToolsItem_Handoff,
...
update_forward_refs(OpenAiModelToolsItem_Mcp)
update_forward_refs(OpenAiModelToolsItem_Query)
update_forward_refs(OpenAiModelToolsItem_SlackMessageSend)
update_forward_refs(OpenAiModelToolsItem_Sms)
update_forward_refs(OpenAiModelToolsItem_TextEditor)
update_forward_refs(OpenAiModelToolsItem_TransferCall)
update_forward_refs(OpenAiModelToolsItem_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(OpenAiModelToolsItem_Voicemail)
