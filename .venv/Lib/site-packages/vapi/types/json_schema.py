...
class JsonSchema(UncheckedBaseModel):
    ...
    items: typing.Optional["JsonSchema"] = pydantic.Field(default=None)
    """
    ...
    properties: typing.Optional[typing.Dict[str, "JsonSchema"]] = pydantic.Field(default=None)
    """
...
update_forward_refs(JsonSchema)
