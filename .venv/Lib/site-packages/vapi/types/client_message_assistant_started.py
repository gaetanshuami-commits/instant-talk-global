...
class ClientMessageAssistantStarted(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ClientMessageAssistantStartedPhoneNumber],
    ...
    type: ClientMessageAssistantStartedType = pydantic.Field()
    """
    ...
    new_assistant: typing_extensions.Annotated[
        "CreateAssistantDto",
        FieldMetadata(alias="newAssistant"),
        pydantic.Field(alias="newAssistant", description="This is the assistant that was updated."),
    ]
