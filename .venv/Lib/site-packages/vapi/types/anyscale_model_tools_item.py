...
class AnyscaleModelToolsItem_ApiRequest(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_Bash(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_Code(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_Computer(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_Dtmf(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_EndCall(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_Function(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_GohighlevelContactCreate(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_GohighlevelContactGet(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_Handoff(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_Mcp(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_Query(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_SlackMessageSend(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_Sms(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_TextEditor(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_TransferCall(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_SipRequest(UncheckedBaseModel):
...
class AnyscaleModelToolsItem_Voicemail(UncheckedBaseModel):
...
AnyscaleModelToolsItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(AnyscaleModelToolsItem_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(AnyscaleModelToolsItem_Bash)
update_forward_refs(AnyscaleModelToolsItem_Code)
update_forward_refs(AnyscaleModelToolsItem_Computer)
update_forward_refs(AnyscaleModelToolsItem_Dtmf)
update_forward_refs(AnyscaleModelToolsItem_EndCall)
update_forward_refs(AnyscaleModelToolsItem_Function)
update_forward_refs(AnyscaleModelToolsItem_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(AnyscaleModelToolsItem_GohighlevelCalendarEventCreate)
update_forward_refs(AnyscaleModelToolsItem_GohighlevelContactCreate)
update_forward_refs(AnyscaleModelToolsItem_GohighlevelContactGet)
update_forward_refs(AnyscaleModelToolsItem_GoogleCalendarAvailabilityCheck)
update_forward_refs(AnyscaleModelToolsItem_GoogleCalendarEventCreate)
update_forward_refs(AnyscaleModelToolsItem_GoogleSheetsRowAppend)
update_forward_refs(
    AnyscaleModelToolsItem_Handoff,
...
update_forward_refs(AnyscaleModelToolsItem_Mcp)
update_forward_refs(AnyscaleModelToolsItem_Query)
update_forward_refs(AnyscaleModelToolsItem_SlackMessageSend)
update_forward_refs(AnyscaleModelToolsItem_Sms)
update_forward_refs(AnyscaleModelToolsItem_TextEditor)
update_forward_refs(AnyscaleModelToolsItem_TransferCall)
update_forward_refs(AnyscaleModelToolsItem_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(AnyscaleModelToolsItem_Voicemail)
