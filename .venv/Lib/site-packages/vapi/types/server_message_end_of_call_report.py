...
from .server_message_end_of_call_report_destination import ServerMessageEndOfCallReportDestination
...
class ServerMessageEndOfCallReport(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ServerMessageEndOfCallReportPhoneNumber],
    ...
    destination: typing.Optional[ServerMessageEndOfCallReportDestination] = pydantic.Field(default=None)
    """
