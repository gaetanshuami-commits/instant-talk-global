...
class ClientMessageToolCallsResult(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ClientMessageToolCallsResultPhoneNumber],
    ...
    tool_call_result: typing_extensions.Annotated[
        ...
        FieldMetadata(alias="toolCallResult"),
        pydantic.Field(alias="toolCallResult", description="This is the result of the tool call."),
    ]
