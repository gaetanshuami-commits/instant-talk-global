...
class GhlToolMessagesItem_RequestStart(UncheckedBaseModel):
...
class GhlToolMessagesItem_RequestComplete(UncheckedBaseModel):
...
class GhlToolMessagesItem_RequestFailed(UncheckedBaseModel):
...
class GhlToolMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
GhlToolMessagesItem = typing_extensions.Annotated[
    typing.Union[
