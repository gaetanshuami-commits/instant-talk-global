...
class UpdateWorkflowDtoModel_Openai(UncheckedBaseModel):
    """
...
class UpdateWorkflowDtoModel_Anthropic(UncheckedBaseModel):
    """
    This is the model for the workflow.
...
class UpdateWorkflowDtoModel_AnthropicBedrock(UncheckedBaseModel):
    """
    This is the model for the workflow.
...
class UpdateWorkflowDtoModel_Google(UncheckedBaseModel):
    """
    This is the model for the workflow.
...
class UpdateWorkflowDtoModel_CustomLlm(UncheckedBaseModel):
    """
    This is the model for the workflow.
...
UpdateWorkflowDtoModel = typing_extensions.Annotated[
    typing.Union[
