...
class ServerMessageResponseAssistantRequestDestination_Number(UncheckedBaseModel):
    """
...
class ServerMessageResponseAssistantRequestDestination_Sip(UncheckedBaseModel):
    """
    This is the destination to transfer the inbound call to. This will immediately transfer without using any assistants.
...
ServerMessageResponseAssistantRequestDestination = typing_extensions.Annotated[
    typing.Union[
