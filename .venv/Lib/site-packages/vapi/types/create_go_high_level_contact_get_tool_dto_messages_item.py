...
class CreateGoHighLevelContactGetToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class CreateGoHighLevelContactGetToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class CreateGoHighLevelContactGetToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class CreateGoHighLevelContactGetToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
CreateGoHighLevelContactGetToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
