...
class HandoffToolMessagesItem_RequestStart(UncheckedBaseModel):
...
class HandoffToolMessagesItem_RequestComplete(UncheckedBaseModel):
...
class HandoffToolMessagesItem_RequestFailed(UncheckedBaseModel):
...
class HandoffToolMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
HandoffToolMessagesItem = typing_extensions.Annotated[
    typing.Union[
