...
class BashToolWithToolCallMessagesItem_RequestStart(UncheckedBaseModel):
...
class BashToolWithToolCallMessagesItem_RequestComplete(UncheckedBaseModel):
...
class BashToolWithToolCallMessagesItem_RequestFailed(UncheckedBaseModel):
...
class BashToolWithToolCallMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
BashToolWithToolCallMessagesItem = typing_extensions.Annotated[
    typing.Union[
