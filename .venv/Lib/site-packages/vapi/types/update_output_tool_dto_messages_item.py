...
class UpdateOutputToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class UpdateOutputToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class UpdateOutputToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class UpdateOutputToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
UpdateOutputToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
