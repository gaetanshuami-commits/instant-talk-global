...
class CreateBashToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class CreateBashToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class CreateBashToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class CreateBashToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
CreateBashToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
