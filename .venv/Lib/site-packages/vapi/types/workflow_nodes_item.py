...
class WorkflowNodesItem_Conversation(UncheckedBaseModel):
...
class WorkflowNodesItem_Tool(UncheckedBaseModel):
...
WorkflowNodesItem = typing_extensions.Annotated[
    typing.Union[WorkflowNodesItem_Conversation, WorkflowNodesItem_Tool], UnionMetadata(discriminant="type")
]
update_forward_refs(WorkflowNodesItem_Conversation)
update_forward_refs(WorkflowNodesItem_Tool)
