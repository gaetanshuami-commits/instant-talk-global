...
class TogetherAiModelToolsItem_ApiRequest(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_Bash(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_Code(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_Computer(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_Dtmf(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_EndCall(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_Function(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_GohighlevelContactCreate(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_GohighlevelContactGet(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_Handoff(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_Mcp(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_Query(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_SlackMessageSend(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_Sms(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_TextEditor(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_TransferCall(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_SipRequest(UncheckedBaseModel):
...
class TogetherAiModelToolsItem_Voicemail(UncheckedBaseModel):
...
TogetherAiModelToolsItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(TogetherAiModelToolsItem_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(TogetherAiModelToolsItem_Bash)
update_forward_refs(TogetherAiModelToolsItem_Code)
update_forward_refs(TogetherAiModelToolsItem_Computer)
update_forward_refs(TogetherAiModelToolsItem_Dtmf)
update_forward_refs(TogetherAiModelToolsItem_EndCall)
update_forward_refs(TogetherAiModelToolsItem_Function)
update_forward_refs(TogetherAiModelToolsItem_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(TogetherAiModelToolsItem_GohighlevelCalendarEventCreate)
update_forward_refs(TogetherAiModelToolsItem_GohighlevelContactCreate)
update_forward_refs(TogetherAiModelToolsItem_GohighlevelContactGet)
update_forward_refs(TogetherAiModelToolsItem_GoogleCalendarAvailabilityCheck)
update_forward_refs(TogetherAiModelToolsItem_GoogleCalendarEventCreate)
...
update_forward_refs(TogetherAiModelToolsItem_Mcp)
update_forward_refs(TogetherAiModelToolsItem_Query)
update_forward_refs(TogetherAiModelToolsItem_SlackMessageSend)
update_forward_refs(TogetherAiModelToolsItem_Sms)
update_forward_refs(TogetherAiModelToolsItem_TextEditor)
update_forward_refs(TogetherAiModelToolsItem_TransferCall)
update_forward_refs(TogetherAiModelToolsItem_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(TogetherAiModelToolsItem_Voicemail)
