...
class CreateTransferCallToolDtoDestinationsItem_Assistant(UncheckedBaseModel):
...
class CreateTransferCallToolDtoDestinationsItem_Number(UncheckedBaseModel):
...
class CreateTransferCallToolDtoDestinationsItem_Sip(UncheckedBaseModel):
...
CreateTransferCallToolDtoDestinationsItem = typing_extensions.Annotated[
    typing.Union[
