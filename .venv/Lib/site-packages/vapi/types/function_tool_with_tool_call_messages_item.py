...
class FunctionToolWithToolCallMessagesItem_RequestStart(UncheckedBaseModel):
...
class FunctionToolWithToolCallMessagesItem_RequestComplete(UncheckedBaseModel):
...
class FunctionToolWithToolCallMessagesItem_RequestFailed(UncheckedBaseModel):
...
class FunctionToolWithToolCallMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
FunctionToolWithToolCallMessagesItem = typing_extensions.Annotated[
    typing.Union[
