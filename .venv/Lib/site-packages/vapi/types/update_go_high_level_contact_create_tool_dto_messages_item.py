...
class UpdateGoHighLevelContactCreateToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class UpdateGoHighLevelContactCreateToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class UpdateGoHighLevelContactCreateToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class UpdateGoHighLevelContactCreateToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
UpdateGoHighLevelContactCreateToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
