...
class TransferCancelToolUserEditableMessagesItem_RequestStart(UncheckedBaseModel):
...
class TransferCancelToolUserEditableMessagesItem_RequestComplete(UncheckedBaseModel):
...
class TransferCancelToolUserEditableMessagesItem_RequestFailed(UncheckedBaseModel):
...
class TransferCancelToolUserEditableMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
TransferCancelToolUserEditableMessagesItem = typing_extensions.Annotated[
    typing.Union[
