...
class CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
