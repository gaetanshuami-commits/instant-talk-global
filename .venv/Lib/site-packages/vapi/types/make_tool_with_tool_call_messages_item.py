...
class MakeToolWithToolCallMessagesItem_RequestStart(UncheckedBaseModel):
...
class MakeToolWithToolCallMessagesItem_RequestComplete(UncheckedBaseModel):
...
class MakeToolWithToolCallMessagesItem_RequestFailed(UncheckedBaseModel):
...
class MakeToolWithToolCallMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
MakeToolWithToolCallMessagesItem = typing_extensions.Annotated[
    typing.Union[
