...
class UpdateToolTemplateDtoDetails_ApiRequest(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_Bash(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_Code(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_Computer(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_Dtmf(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_EndCall(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_Function(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_GohighlevelContactCreate(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_GohighlevelContactGet(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_Handoff(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_Mcp(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_Query(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_SlackMessageSend(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_Sms(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_TextEditor(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_TransferCall(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_SipRequest(UncheckedBaseModel):
...
class UpdateToolTemplateDtoDetails_Voicemail(UncheckedBaseModel):
...
UpdateToolTemplateDtoDetails = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(UpdateToolTemplateDtoDetails_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(UpdateToolTemplateDtoDetails_Bash)
update_forward_refs(UpdateToolTemplateDtoDetails_Code)
update_forward_refs(UpdateToolTemplateDtoDetails_Computer)
update_forward_refs(UpdateToolTemplateDtoDetails_Dtmf)
update_forward_refs(UpdateToolTemplateDtoDetails_EndCall)
update_forward_refs(UpdateToolTemplateDtoDetails_Function)
update_forward_refs(UpdateToolTemplateDtoDetails_GohighlevelCalendarAvailabilityCheck)
...
update_forward_refs(UpdateToolTemplateDtoDetails_GohighlevelContactGet)
update_forward_refs(UpdateToolTemplateDtoDetails_GoogleCalendarAvailabilityCheck)
update_forward_refs(UpdateToolTemplateDtoDetails_GoogleCalendarEventCreate)
update_forward_refs(UpdateToolTemplateDtoDetails_GoogleSheetsRowAppend)
update_forward_refs(
    UpdateToolTemplateDtoDetails_Handoff,
...
update_forward_refs(UpdateToolTemplateDtoDetails_Mcp)
update_forward_refs(UpdateToolTemplateDtoDetails_Query)
update_forward_refs(UpdateToolTemplateDtoDetails_SlackMessageSend)
update_forward_refs(UpdateToolTemplateDtoDetails_Sms)
update_forward_refs(UpdateToolTemplateDtoDetails_TextEditor)
update_forward_refs(UpdateToolTemplateDtoDetails_TransferCall)
update_forward_refs(UpdateToolTemplateDtoDetails_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(UpdateToolTemplateDtoDetails_Voicemail)
