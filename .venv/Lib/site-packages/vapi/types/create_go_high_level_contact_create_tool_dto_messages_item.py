...
class CreateGoHighLevelContactCreateToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class CreateGoHighLevelContactCreateToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class CreateGoHighLevelContactCreateToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class CreateGoHighLevelContactCreateToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
CreateGoHighLevelContactCreateToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
