...
class UpdateMakeToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class UpdateMakeToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class UpdateMakeToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class UpdateMakeToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
UpdateMakeToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
