...
class PhoneNumberPaginatedResponseResultsItem_ByoPhoneNumber(UncheckedBaseModel):
...
class PhoneNumberPaginatedResponseResultsItem_Twilio(UncheckedBaseModel):
...
class PhoneNumberPaginatedResponseResultsItem_Vonage(UncheckedBaseModel):
...
class PhoneNumberPaginatedResponseResultsItem_Vapi(UncheckedBaseModel):
...
class PhoneNumberPaginatedResponseResultsItem_Telnyx(UncheckedBaseModel):
...
PhoneNumberPaginatedResponseResultsItem = typing_extensions.Annotated[
    typing.Union[
