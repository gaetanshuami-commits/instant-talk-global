...
class XaiModelToolsItem_ApiRequest(UncheckedBaseModel):
...
class XaiModelToolsItem_Bash(UncheckedBaseModel):
...
class XaiModelToolsItem_Code(UncheckedBaseModel):
...
class XaiModelToolsItem_Computer(UncheckedBaseModel):
...
class XaiModelToolsItem_Dtmf(UncheckedBaseModel):
...
class XaiModelToolsItem_EndCall(UncheckedBaseModel):
...
class XaiModelToolsItem_Function(UncheckedBaseModel):
...
class XaiModelToolsItem_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class XaiModelToolsItem_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class XaiModelToolsItem_GohighlevelContactCreate(UncheckedBaseModel):
...
class XaiModelToolsItem_GohighlevelContactGet(UncheckedBaseModel):
...
class XaiModelToolsItem_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class XaiModelToolsItem_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class XaiModelToolsItem_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class XaiModelToolsItem_Handoff(UncheckedBaseModel):
...
class XaiModelToolsItem_Mcp(UncheckedBaseModel):
...
class XaiModelToolsItem_Query(UncheckedBaseModel):
...
class XaiModelToolsItem_SlackMessageSend(UncheckedBaseModel):
...
class XaiModelToolsItem_Sms(UncheckedBaseModel):
...
class XaiModelToolsItem_TextEditor(UncheckedBaseModel):
...
class XaiModelToolsItem_TransferCall(UncheckedBaseModel):
...
class XaiModelToolsItem_SipRequest(UncheckedBaseModel):
...
class XaiModelToolsItem_Voicemail(UncheckedBaseModel):
...
XaiModelToolsItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(XaiModelToolsItem_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(XaiModelToolsItem_Bash)
update_forward_refs(XaiModelToolsItem_Code)
update_forward_refs(XaiModelToolsItem_Computer)
update_forward_refs(XaiModelToolsItem_Dtmf)
update_forward_refs(XaiModelToolsItem_EndCall)
update_forward_refs(XaiModelToolsItem_Function)
...
update_forward_refs(XaiModelToolsItem_GohighlevelContactCreate)
update_forward_refs(XaiModelToolsItem_GohighlevelContactGet)
update_forward_refs(XaiModelToolsItem_GoogleCalendarAvailabilityCheck)
update_forward_refs(XaiModelToolsItem_GoogleCalendarEventCreate)
update_forward_refs(XaiModelToolsItem_GoogleSheetsRowAppend)
update_forward_refs(
    XaiModelToolsItem_Handoff,
...
update_forward_refs(XaiModelToolsItem_Mcp)
update_forward_refs(XaiModelToolsItem_Query)
update_forward_refs(XaiModelToolsItem_SlackMessageSend)
update_forward_refs(XaiModelToolsItem_Sms)
update_forward_refs(XaiModelToolsItem_TextEditor)
update_forward_refs(XaiModelToolsItem_TransferCall)
update_forward_refs(XaiModelToolsItem_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(XaiModelToolsItem_Voicemail)
