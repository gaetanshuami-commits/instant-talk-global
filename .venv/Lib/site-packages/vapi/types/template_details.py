...
class TemplateDetails_ApiRequest(UncheckedBaseModel):
...
class TemplateDetails_Bash(UncheckedBaseModel):
...
class TemplateDetails_Code(UncheckedBaseModel):
...
class TemplateDetails_Computer(UncheckedBaseModel):
...
class TemplateDetails_Dtmf(UncheckedBaseModel):
...
class TemplateDetails_EndCall(UncheckedBaseModel):
...
class TemplateDetails_Function(UncheckedBaseModel):
...
class TemplateDetails_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class TemplateDetails_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class TemplateDetails_GohighlevelContactCreate(UncheckedBaseModel):
...
class TemplateDetails_GohighlevelContactGet(UncheckedBaseModel):
...
class TemplateDetails_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class TemplateDetails_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class TemplateDetails_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class TemplateDetails_Handoff(UncheckedBaseModel):
...
class TemplateDetails_Mcp(UncheckedBaseModel):
...
class TemplateDetails_Query(UncheckedBaseModel):
...
class TemplateDetails_SlackMessageSend(UncheckedBaseModel):
...
class TemplateDetails_Sms(UncheckedBaseModel):
...
class TemplateDetails_TextEditor(UncheckedBaseModel):
...
class TemplateDetails_TransferCall(UncheckedBaseModel):
...
class TemplateDetails_SipRequest(UncheckedBaseModel):
...
class TemplateDetails_Voicemail(UncheckedBaseModel):
...
TemplateDetails = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(TemplateDetails_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(TemplateDetails_Bash)
update_forward_refs(TemplateDetails_Code)
update_forward_refs(TemplateDetails_Computer)
update_forward_refs(TemplateDetails_Dtmf)
update_forward_refs(TemplateDetails_EndCall)
update_forward_refs(TemplateDetails_Function)
update_forward_refs(TemplateDetails_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(TemplateDetails_GohighlevelCalendarEventCreate)
update_forward_refs(TemplateDetails_GohighlevelContactCreate)
update_forward_refs(TemplateDetails_GohighlevelContactGet)
update_forward_refs(TemplateDetails_GoogleCalendarAvailabilityCheck)
update_forward_refs(TemplateDetails_GoogleCalendarEventCreate)
update_forward_refs(TemplateDetails_GoogleSheetsRowAppend)
update_forward_refs(
    TemplateDetails_Handoff,
...
update_forward_refs(TemplateDetails_Mcp)
update_forward_refs(TemplateDetails_Query)
update_forward_refs(TemplateDetails_SlackMessageSend)
update_forward_refs(TemplateDetails_Sms)
update_forward_refs(TemplateDetails_TextEditor)
update_forward_refs(TemplateDetails_TransferCall)
update_forward_refs(TemplateDetails_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(TemplateDetails_Voicemail)
