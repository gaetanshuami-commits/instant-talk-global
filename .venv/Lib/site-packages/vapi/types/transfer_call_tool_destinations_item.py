...
class TransferCallToolDestinationsItem_Assistant(UncheckedBaseModel):
...
class TransferCallToolDestinationsItem_Number(UncheckedBaseModel):
...
class TransferCallToolDestinationsItem_Sip(UncheckedBaseModel):
...
TransferCallToolDestinationsItem = typing_extensions.Annotated[
    typing.Union[
