...
class UpdateTransferCallToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class UpdateTransferCallToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class UpdateTransferCallToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class UpdateTransferCallToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
UpdateTransferCallToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
