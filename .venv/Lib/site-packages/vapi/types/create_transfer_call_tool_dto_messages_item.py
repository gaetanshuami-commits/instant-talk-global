...
class CreateTransferCallToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class CreateTransferCallToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class CreateTransferCallToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class CreateTransferCallToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
CreateTransferCallToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
