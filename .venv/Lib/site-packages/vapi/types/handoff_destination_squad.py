...
class HandoffDestinationSquad(UncheckedBaseModel):
    ...
    squad_id: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="squadId", description="This is the squad id to transfer the call to."),
    ] = None
    ...
    entry_assistant_name: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="entryAssistantName"),
        pydantic.Field(
            alias="entryAssistantName",
    ...
    variable_extraction_plan: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="variableExtractionPlan", description="This is the variable extraction plan for the handoff tool."
        ),
    ] = None
