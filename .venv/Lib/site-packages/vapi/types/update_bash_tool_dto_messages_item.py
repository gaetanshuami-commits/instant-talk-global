...
class UpdateBashToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class UpdateBashToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class UpdateBashToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class UpdateBashToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
UpdateBashToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
