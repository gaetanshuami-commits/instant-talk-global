...
class OpenRouterModelToolsItem_ApiRequest(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_Bash(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_Code(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_Computer(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_Dtmf(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_EndCall(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_Function(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_GohighlevelContactCreate(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_GohighlevelContactGet(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_Handoff(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_Mcp(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_Query(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_SlackMessageSend(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_Sms(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_TextEditor(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_TransferCall(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_SipRequest(UncheckedBaseModel):
...
class OpenRouterModelToolsItem_Voicemail(UncheckedBaseModel):
...
OpenRouterModelToolsItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(OpenRouterModelToolsItem_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(OpenRouterModelToolsItem_Bash)
update_forward_refs(OpenRouterModelToolsItem_Code)
update_forward_refs(OpenRouterModelToolsItem_Computer)
update_forward_refs(OpenRouterModelToolsItem_Dtmf)
update_forward_refs(OpenRouterModelToolsItem_EndCall)
update_forward_refs(OpenRouterModelToolsItem_Function)
update_forward_refs(OpenRouterModelToolsItem_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(OpenRouterModelToolsItem_GohighlevelCalendarEventCreate)
update_forward_refs(OpenRouterModelToolsItem_GohighlevelContactCreate)
update_forward_refs(OpenRouterModelToolsItem_GohighlevelContactGet)
update_forward_refs(OpenRouterModelToolsItem_GoogleCalendarAvailabilityCheck)
update_forward_refs(OpenRouterModelToolsItem_GoogleCalendarEventCreate)
update_forward_refs(OpenRouterModelToolsItem_GoogleSheetsRowAppend)
update_forward_refs(
    OpenRouterModelToolsItem_Handoff,
...
update_forward_refs(OpenRouterModelToolsItem_Mcp)
update_forward_refs(OpenRouterModelToolsItem_Query)
update_forward_refs(OpenRouterModelToolsItem_SlackMessageSend)
update_forward_refs(OpenRouterModelToolsItem_Sms)
update_forward_refs(OpenRouterModelToolsItem_TextEditor)
update_forward_refs(OpenRouterModelToolsItem_TransferCall)
update_forward_refs(OpenRouterModelToolsItem_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(OpenRouterModelToolsItem_Voicemail)
