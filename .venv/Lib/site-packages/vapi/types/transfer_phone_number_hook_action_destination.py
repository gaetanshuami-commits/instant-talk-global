...
class TransferPhoneNumberHookActionDestination_Number(UncheckedBaseModel):
    """
...
class TransferPhoneNumberHookActionDestination_Sip(UncheckedBaseModel):
    """
    This is the destination details for the transfer - can be a phone number or SIP URI
    """
...
TransferPhoneNumberHookActionDestination = typing_extensions.Annotated[
    typing.Union[TransferPhoneNumberHookActionDestination_Number, TransferPhoneNumberHookActionDestination_Sip],
