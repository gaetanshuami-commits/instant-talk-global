...
class AnthropicBedrockModel(UncheckedBaseModel):
    messages: typing.Optional[typing.List[OpenAiMessage]] = pydantic.Field(default=None)
    """
    This is the starting state for the conversation.
    """

    tools: typing.Optional[typing.List["AnthropicBedrockModelToolsItem"]] = pydantic.Field(default=None)
    """
    ...
    model: AnthropicBedrockModelModel = pydantic.Field()
    """
