...
class TextEditorToolMessagesItem_RequestStart(UncheckedBaseModel):
...
class TextEditorToolMessagesItem_RequestComplete(UncheckedBaseModel):
...
class TextEditorToolMessagesItem_RequestFailed(UncheckedBaseModel):
...
class TextEditorToolMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
TextEditorToolMessagesItem = typing_extensions.Annotated[
    typing.Union[
