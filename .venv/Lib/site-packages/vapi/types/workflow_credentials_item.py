...
class WorkflowCredentialsItem_11Labs(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Anthropic(UncheckedBaseModel):
...
class WorkflowCredentialsItem_AnthropicBedrock(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Anyscale(UncheckedBaseModel):
...
class WorkflowCredentialsItem_AssemblyAi(UncheckedBaseModel):
...
class WorkflowCredentialsItem_AzureOpenai(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Azure(UncheckedBaseModel):
...
class WorkflowCredentialsItem_ByoSipTrunk(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Cartesia(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Cerebras(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Cloudflare(UncheckedBaseModel):
...
class WorkflowCredentialsItem_CustomLlm(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Deepgram(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Deepinfra(UncheckedBaseModel):
...
class WorkflowCredentialsItem_DeepSeek(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Gcp(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Gladia(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Gohighlevel(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Google(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Groq(UncheckedBaseModel):
...
class WorkflowCredentialsItem_InflectionAi(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Langfuse(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Lmnt(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Make(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Openai(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Openrouter(UncheckedBaseModel):
...
class WorkflowCredentialsItem_PerplexityAi(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Playht(UncheckedBaseModel):
...
class WorkflowCredentialsItem_RimeAi(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Runpod(UncheckedBaseModel):
...
class WorkflowCredentialsItem_S3(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Supabase(UncheckedBaseModel):
...
class WorkflowCredentialsItem_SmallestAi(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Tavus(UncheckedBaseModel):
...
class WorkflowCredentialsItem_TogetherAi(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Twilio(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Vonage(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Webhook(UncheckedBaseModel):
...
class WorkflowCredentialsItem_CustomCredential(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Xai(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Neuphonic(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Hume(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Mistral(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Speechmatics(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Soniox(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Trieve(UncheckedBaseModel):
...
class WorkflowCredentialsItem_GoogleCalendarOauth2Client(UncheckedBaseModel):
...
class WorkflowCredentialsItem_GoogleCalendarOauth2Authorization(UncheckedBaseModel):
...
class WorkflowCredentialsItem_GoogleSheetsOauth2Authorization(UncheckedBaseModel):
...
class WorkflowCredentialsItem_SlackOauth2Authorization(UncheckedBaseModel):
...
class WorkflowCredentialsItem_GhlOauth2Authorization(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Inworld(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Minimax(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Wellsaid(UncheckedBaseModel):
...
class WorkflowCredentialsItem_Email(UncheckedBaseModel):
...
class WorkflowCredentialsItem_SlackWebhook(UncheckedBaseModel):
...
WorkflowCredentialsItem = typing_extensions.Annotated[
    typing.Union[
