...
class CreateCodeToolDto(UncheckedBaseModel):
    messages: typing.Optional[typing.List[CreateCodeToolDtoMessagesItem]] = pydantic.Field(default=None)
    """
    ...
    environment_variables: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="environmentVariables", description="Environment variables available in code via `env` object"
        ),
    ] = None
    ...
    credential_id: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="credentialId", description="Credential ID containing the Val Town API key"),
    ] = None
...
update_forward_refs(CreateCodeToolDto)
