...
class PerplexityAiModelToolsItem_ApiRequest(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_Bash(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_Code(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_Computer(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_Dtmf(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_EndCall(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_Function(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_GohighlevelContactCreate(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_GohighlevelContactGet(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_Handoff(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_Mcp(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_Query(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_SlackMessageSend(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_Sms(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_TextEditor(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_TransferCall(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_SipRequest(UncheckedBaseModel):
...
class PerplexityAiModelToolsItem_Voicemail(UncheckedBaseModel):
...
PerplexityAiModelToolsItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(PerplexityAiModelToolsItem_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(PerplexityAiModelToolsItem_Bash)
update_forward_refs(PerplexityAiModelToolsItem_Code)
update_forward_refs(PerplexityAiModelToolsItem_Computer)
update_forward_refs(PerplexityAiModelToolsItem_Dtmf)
update_forward_refs(PerplexityAiModelToolsItem_EndCall)
update_forward_refs(PerplexityAiModelToolsItem_Function)
update_forward_refs(PerplexityAiModelToolsItem_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(PerplexityAiModelToolsItem_GohighlevelCalendarEventCreate)
update_forward_refs(PerplexityAiModelToolsItem_GohighlevelContactCreate)
update_forward_refs(PerplexityAiModelToolsItem_GohighlevelContactGet)
update_forward_refs(PerplexityAiModelToolsItem_GoogleCalendarAvailabilityCheck)
update_forward_refs(PerplexityAiModelToolsItem_GoogleCalendarEventCreate)
update_forward_refs(PerplexityAiModelToolsItem_GoogleSheetsRowAppend)
update_forward_refs(
    PerplexityAiModelToolsItem_Handoff,
...
update_forward_refs(PerplexityAiModelToolsItem_Mcp)
update_forward_refs(PerplexityAiModelToolsItem_Query)
update_forward_refs(PerplexityAiModelToolsItem_SlackMessageSend)
update_forward_refs(PerplexityAiModelToolsItem_Sms)
update_forward_refs(PerplexityAiModelToolsItem_TextEditor)
update_forward_refs(PerplexityAiModelToolsItem_TransferCall)
update_forward_refs(PerplexityAiModelToolsItem_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(PerplexityAiModelToolsItem_Voicemail)
