...
class CallHookCustomerSpeechTimeoutDoItem_Say(UncheckedBaseModel):
...
class CallHookCustomerSpeechTimeoutDoItem_Tool(UncheckedBaseModel):
...
class CallHookCustomerSpeechTimeoutDoItem_MessageAdd(UncheckedBaseModel):
...
CallHookCustomerSpeechTimeoutDoItem = typing_extensions.Annotated[
    typing.Union[
