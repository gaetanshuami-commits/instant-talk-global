...
class UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
