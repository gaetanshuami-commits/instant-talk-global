...
class MinimaxLlmModelToolsItem_ApiRequest(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_Bash(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_Code(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_Computer(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_Dtmf(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_EndCall(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_Function(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_GohighlevelContactCreate(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_GohighlevelContactGet(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_Handoff(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_Mcp(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_Query(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_SlackMessageSend(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_Sms(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_TextEditor(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_TransferCall(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_SipRequest(UncheckedBaseModel):
...
class MinimaxLlmModelToolsItem_Voicemail(UncheckedBaseModel):
...
MinimaxLlmModelToolsItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(MinimaxLlmModelToolsItem_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(MinimaxLlmModelToolsItem_Bash)
update_forward_refs(MinimaxLlmModelToolsItem_Code)
update_forward_refs(MinimaxLlmModelToolsItem_Computer)
update_forward_refs(MinimaxLlmModelToolsItem_Dtmf)
update_forward_refs(MinimaxLlmModelToolsItem_EndCall)
update_forward_refs(MinimaxLlmModelToolsItem_Function)
update_forward_refs(MinimaxLlmModelToolsItem_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(MinimaxLlmModelToolsItem_GohighlevelCalendarEventCreate)
update_forward_refs(MinimaxLlmModelToolsItem_GohighlevelContactCreate)
update_forward_refs(MinimaxLlmModelToolsItem_GohighlevelContactGet)
update_forward_refs(MinimaxLlmModelToolsItem_GoogleCalendarAvailabilityCheck)
update_forward_refs(MinimaxLlmModelToolsItem_GoogleCalendarEventCreate)
update_forward_refs(MinimaxLlmModelToolsItem_GoogleSheetsRowAppend)
update_forward_refs(
    MinimaxLlmModelToolsItem_Handoff,
...
update_forward_refs(MinimaxLlmModelToolsItem_Mcp)
update_forward_refs(MinimaxLlmModelToolsItem_Query)
update_forward_refs(MinimaxLlmModelToolsItem_SlackMessageSend)
update_forward_refs(MinimaxLlmModelToolsItem_Sms)
update_forward_refs(MinimaxLlmModelToolsItem_TextEditor)
update_forward_refs(MinimaxLlmModelToolsItem_TransferCall)
update_forward_refs(MinimaxLlmModelToolsItem_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(MinimaxLlmModelToolsItem_Voicemail)
