...
class TrieveKnowledgeBaseChunkPlan(UncheckedBaseModel):
    ...
    target_splits_per_chunk: typing_extensions.Annotated[
        ...
        FieldMetadata(alias="targetSplitsPerChunk"),
        pydantic.Field(
            alias="targetSplitsPerChunk",
    ...
    split_delimiters: typing_extensions.Annotated[
        typing.Optional[typing.List[str]],
        FieldMetadata(alias="splitDelimiters"),
        pydantic.Field(
            alias="splitDelimiters",
    ...
    rebalance_chunks: typing_extensions.Annotated[
        typing.Optional[bool],
        FieldMetadata(alias="rebalanceChunks"),
        pydantic.Field(
            alias="rebalanceChunks",
