...
class CreateVapiPhoneNumberDtoFallbackDestination_Number(UncheckedBaseModel):
    """
...
class CreateVapiPhoneNumberDtoFallbackDestination_Sip(UncheckedBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
    1. `assistantId` is not set
    2. `squadId` is not set
...
CreateVapiPhoneNumberDtoFallbackDestination = typing_extensions.Annotated[
    typing.Union[CreateVapiPhoneNumberDtoFallbackDestination_Number, CreateVapiPhoneNumberDtoFallbackDestination_Sip],
