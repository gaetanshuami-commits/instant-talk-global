...
class UpdateEndCallToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class UpdateEndCallToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class UpdateEndCallToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class UpdateEndCallToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
UpdateEndCallToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
