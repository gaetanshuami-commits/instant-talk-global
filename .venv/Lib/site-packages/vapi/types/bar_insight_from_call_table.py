...
class BarInsightFromCallTable(UncheckedBaseModel):
    name: typing.Optional[str] = pydantic.Field(default=None)
    """
    This is the name of the Insight.
    """

    type: BarInsightFromCallTableType = pydantic.Field()
    """
    ...
    group_by: typing_extensions.Annotated[
        typing.Optional[BarInsightFromCallTableGroupBy],
    ...
    queries: typing.List[BarInsightFromCallTableQueriesItem] = pydantic.Field()
    """
