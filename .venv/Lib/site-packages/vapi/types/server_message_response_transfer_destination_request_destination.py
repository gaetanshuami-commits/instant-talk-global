...
class ServerMessageResponseTransferDestinationRequestDestination_Assistant(UncheckedBaseModel):
    """
...
class ServerMessageResponseTransferDestinationRequestDestination_Number(UncheckedBaseModel):
    """
    This is the destination you'd like the call to be transferred to.
    """
...
class ServerMessageResponseTransferDestinationRequestDestination_Sip(UncheckedBaseModel):
    """
    This is the destination you'd like the call to be transferred to.
    """
...
ServerMessageResponseTransferDestinationRequestDestination = typing_extensions.Annotated[
    typing.Union[
