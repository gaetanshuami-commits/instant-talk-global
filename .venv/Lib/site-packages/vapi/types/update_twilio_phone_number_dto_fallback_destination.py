...
class UpdateTwilioPhoneNumberDtoFallbackDestination_Number(UncheckedBaseModel):
    """
...
class UpdateTwilioPhoneNumberDtoFallbackDestination_Sip(UncheckedBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
    1. `assistantId` is not set
    2. `squadId` is not set
...
UpdateTwilioPhoneNumberDtoFallbackDestination = typing_extensions.Annotated[
    typing.Union[
        UpdateTwilioPhoneNumberDtoFallbackDestination_Number, UpdateTwilioPhoneNumberDtoFallbackDestination_Sip
    ],
