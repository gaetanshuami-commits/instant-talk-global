...
class VapiModelToolsItem_ApiRequest(UncheckedBaseModel):
...
class VapiModelToolsItem_Bash(UncheckedBaseModel):
...
class VapiModelToolsItem_Code(UncheckedBaseModel):
...
class VapiModelToolsItem_Computer(UncheckedBaseModel):
...
class VapiModelToolsItem_Dtmf(UncheckedBaseModel):
...
class VapiModelToolsItem_EndCall(UncheckedBaseModel):
...
class VapiModelToolsItem_Function(UncheckedBaseModel):
...
class VapiModelToolsItem_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class VapiModelToolsItem_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class VapiModelToolsItem_GohighlevelContactCreate(UncheckedBaseModel):
...
class VapiModelToolsItem_GohighlevelContactGet(UncheckedBaseModel):
...
class VapiModelToolsItem_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class VapiModelToolsItem_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class VapiModelToolsItem_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class VapiModelToolsItem_Handoff(UncheckedBaseModel):
...
class VapiModelToolsItem_Mcp(UncheckedBaseModel):
...
class VapiModelToolsItem_Query(UncheckedBaseModel):
...
class VapiModelToolsItem_SlackMessageSend(UncheckedBaseModel):
...
class VapiModelToolsItem_Sms(UncheckedBaseModel):
...
class VapiModelToolsItem_TextEditor(UncheckedBaseModel):
...
class VapiModelToolsItem_TransferCall(UncheckedBaseModel):
...
class VapiModelToolsItem_SipRequest(UncheckedBaseModel):
...
class VapiModelToolsItem_Voicemail(UncheckedBaseModel):
...
VapiModelToolsItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(VapiModelToolsItem_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(VapiModelToolsItem_Bash)
update_forward_refs(VapiModelToolsItem_Code)
update_forward_refs(VapiModelToolsItem_Computer)
update_forward_refs(VapiModelToolsItem_Dtmf)
update_forward_refs(VapiModelToolsItem_EndCall)
update_forward_refs(VapiModelToolsItem_Function)
update_forward_refs(VapiModelToolsItem_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(VapiModelToolsItem_GohighlevelCalendarEventCreate)
update_forward_refs(VapiModelToolsItem_GohighlevelContactCreate)
update_forward_refs(VapiModelToolsItem_GohighlevelContactGet)
update_forward_refs(VapiModelToolsItem_GoogleCalendarAvailabilityCheck)
update_forward_refs(VapiModelToolsItem_GoogleCalendarEventCreate)
...
update_forward_refs(VapiModelToolsItem_Mcp)
update_forward_refs(VapiModelToolsItem_Query)
update_forward_refs(VapiModelToolsItem_SlackMessageSend)
update_forward_refs(VapiModelToolsItem_Sms)
update_forward_refs(VapiModelToolsItem_TextEditor)
update_forward_refs(VapiModelToolsItem_TransferCall)
update_forward_refs(VapiModelToolsItem_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(VapiModelToolsItem_Voicemail)
