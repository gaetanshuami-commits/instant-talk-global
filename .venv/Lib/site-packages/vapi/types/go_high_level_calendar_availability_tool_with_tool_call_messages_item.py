...
class GoHighLevelCalendarAvailabilityToolWithToolCallMessagesItem_RequestStart(UncheckedBaseModel):
...
class GoHighLevelCalendarAvailabilityToolWithToolCallMessagesItem_RequestComplete(UncheckedBaseModel):
...
class GoHighLevelCalendarAvailabilityToolWithToolCallMessagesItem_RequestFailed(UncheckedBaseModel):
...
class GoHighLevelCalendarAvailabilityToolWithToolCallMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
GoHighLevelCalendarAvailabilityToolWithToolCallMessagesItem = typing_extensions.Annotated[
    typing.Union[
