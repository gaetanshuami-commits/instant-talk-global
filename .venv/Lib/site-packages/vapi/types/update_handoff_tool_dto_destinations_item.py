...
class UpdateHandoffToolDtoDestinationsItem_Assistant(UncheckedBaseModel):
...
class UpdateHandoffToolDtoDestinationsItem_Dynamic(UncheckedBaseModel):
...
class UpdateHandoffToolDtoDestinationsItem_Squad(UncheckedBaseModel):
...
UpdateHandoffToolDtoDestinationsItem = typing_extensions.Annotated[
    typing.Union[
