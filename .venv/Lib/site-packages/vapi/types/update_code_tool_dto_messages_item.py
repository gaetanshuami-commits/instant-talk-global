...
class UpdateCodeToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class UpdateCodeToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
UpdateCodeToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
