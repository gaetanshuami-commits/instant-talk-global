...
class GroqModelToolsItem_ApiRequest(UncheckedBaseModel):
...
class GroqModelToolsItem_Bash(UncheckedBaseModel):
...
class GroqModelToolsItem_Code(UncheckedBaseModel):
...
class GroqModelToolsItem_Computer(UncheckedBaseModel):
...
class GroqModelToolsItem_Dtmf(UncheckedBaseModel):
...
class GroqModelToolsItem_EndCall(UncheckedBaseModel):
...
class GroqModelToolsItem_Function(UncheckedBaseModel):
...
class GroqModelToolsItem_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class GroqModelToolsItem_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class GroqModelToolsItem_GohighlevelContactCreate(UncheckedBaseModel):
...
class GroqModelToolsItem_GohighlevelContactGet(UncheckedBaseModel):
...
class GroqModelToolsItem_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class GroqModelToolsItem_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class GroqModelToolsItem_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class GroqModelToolsItem_Handoff(UncheckedBaseModel):
...
class GroqModelToolsItem_Mcp(UncheckedBaseModel):
...
class GroqModelToolsItem_Query(UncheckedBaseModel):
...
class GroqModelToolsItem_SlackMessageSend(UncheckedBaseModel):
...
class GroqModelToolsItem_Sms(UncheckedBaseModel):
...
class GroqModelToolsItem_TextEditor(UncheckedBaseModel):
...
class GroqModelToolsItem_TransferCall(UncheckedBaseModel):
...
class GroqModelToolsItem_SipRequest(UncheckedBaseModel):
...
class GroqModelToolsItem_Voicemail(UncheckedBaseModel):
...
GroqModelToolsItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(GroqModelToolsItem_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(GroqModelToolsItem_Bash)
update_forward_refs(GroqModelToolsItem_Code)
update_forward_refs(GroqModelToolsItem_Computer)
update_forward_refs(GroqModelToolsItem_Dtmf)
update_forward_refs(GroqModelToolsItem_EndCall)
update_forward_refs(GroqModelToolsItem_Function)
update_forward_refs(GroqModelToolsItem_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(GroqModelToolsItem_GohighlevelCalendarEventCreate)
update_forward_refs(GroqModelToolsItem_GohighlevelContactCreate)
update_forward_refs(GroqModelToolsItem_GohighlevelContactGet)
update_forward_refs(GroqModelToolsItem_GoogleCalendarAvailabilityCheck)
update_forward_refs(GroqModelToolsItem_GoogleCalendarEventCreate)
update_forward_refs(GroqModelToolsItem_GoogleSheetsRowAppend)
update_forward_refs(
    GroqModelToolsItem_Handoff,
...
update_forward_refs(GroqModelToolsItem_Mcp)
update_forward_refs(GroqModelToolsItem_Query)
update_forward_refs(GroqModelToolsItem_SlackMessageSend)
update_forward_refs(GroqModelToolsItem_Sms)
update_forward_refs(GroqModelToolsItem_TextEditor)
update_forward_refs(GroqModelToolsItem_TransferCall)
update_forward_refs(GroqModelToolsItem_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(GroqModelToolsItem_Voicemail)
