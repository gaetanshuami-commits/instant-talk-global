...
class UpdateMcpToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class UpdateMcpToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class UpdateMcpToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class UpdateMcpToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
UpdateMcpToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
