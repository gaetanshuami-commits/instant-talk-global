...
class CreateDtmfToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class CreateDtmfToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class CreateDtmfToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class CreateDtmfToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
CreateDtmfToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
