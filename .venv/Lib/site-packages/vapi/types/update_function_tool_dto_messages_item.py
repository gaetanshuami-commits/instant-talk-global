...
class UpdateFunctionToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class UpdateFunctionToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class UpdateFunctionToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class UpdateFunctionToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
UpdateFunctionToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
