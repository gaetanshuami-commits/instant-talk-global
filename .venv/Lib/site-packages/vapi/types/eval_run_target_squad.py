...
class EvalRunTargetSquad(UncheckedBaseModel):
    ...
    assistant_overrides: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="assistantOverrides", description="This is the overrides that will be applied to the assistants."
        ),
    ] = None
    squad_id: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="squadId"),
        pydantic.Field(alias="squadId", description="This is the id of the squad that will be run against the eval"),
    ] = None
