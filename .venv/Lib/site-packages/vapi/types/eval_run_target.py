...
class EvalRunTarget_Assistant(UncheckedBaseModel):
    """
...
class EvalRunTarget_Squad(UncheckedBaseModel):
    """
    This is the target that will be run against the eval
    """
...
EvalRunTarget = typing_extensions.Annotated[
    typing.Union[EvalRunTarget_Assistant, EvalRunTarget_Squad], UnionMetadata(discriminant="type")
]
