...
class EndCallToolMessagesItem_RequestStart(UncheckedBaseModel):
...
class EndCallToolMessagesItem_RequestComplete(UncheckedBaseModel):
...
class EndCallToolMessagesItem_RequestFailed(UncheckedBaseModel):
...
class EndCallToolMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
EndCallToolMessagesItem = typing_extensions.Annotated[
    typing.Union[
