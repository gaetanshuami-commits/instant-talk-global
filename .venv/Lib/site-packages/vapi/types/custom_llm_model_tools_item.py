...
class CustomLlmModelToolsItem_ApiRequest(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_Bash(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_Code(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_Computer(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_Dtmf(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_EndCall(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_Function(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_GohighlevelContactCreate(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_GohighlevelContactGet(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_Handoff(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_Mcp(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_Query(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_SlackMessageSend(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_Sms(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_TextEditor(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_TransferCall(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_SipRequest(UncheckedBaseModel):
...
class CustomLlmModelToolsItem_Voicemail(UncheckedBaseModel):
...
CustomLlmModelToolsItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(CustomLlmModelToolsItem_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(CustomLlmModelToolsItem_Bash)
update_forward_refs(CustomLlmModelToolsItem_Code)
update_forward_refs(CustomLlmModelToolsItem_Computer)
update_forward_refs(CustomLlmModelToolsItem_Dtmf)
update_forward_refs(CustomLlmModelToolsItem_EndCall)
update_forward_refs(CustomLlmModelToolsItem_Function)
update_forward_refs(CustomLlmModelToolsItem_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(CustomLlmModelToolsItem_GohighlevelCalendarEventCreate)
update_forward_refs(CustomLlmModelToolsItem_GohighlevelContactCreate)
update_forward_refs(CustomLlmModelToolsItem_GohighlevelContactGet)
update_forward_refs(CustomLlmModelToolsItem_GoogleCalendarAvailabilityCheck)
update_forward_refs(CustomLlmModelToolsItem_GoogleCalendarEventCreate)
update_forward_refs(CustomLlmModelToolsItem_GoogleSheetsRowAppend)
update_forward_refs(
    CustomLlmModelToolsItem_Handoff,
...
update_forward_refs(CustomLlmModelToolsItem_Mcp)
update_forward_refs(CustomLlmModelToolsItem_Query)
update_forward_refs(CustomLlmModelToolsItem_SlackMessageSend)
update_forward_refs(CustomLlmModelToolsItem_Sms)
update_forward_refs(CustomLlmModelToolsItem_TextEditor)
update_forward_refs(CustomLlmModelToolsItem_TransferCall)
update_forward_refs(CustomLlmModelToolsItem_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(CustomLlmModelToolsItem_Voicemail)
