...
class CreateTelnyxPhoneNumberDtoFallbackDestination_Number(UncheckedBaseModel):
    """
...
class CreateTelnyxPhoneNumberDtoFallbackDestination_Sip(UncheckedBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
    1. `assistantId` is not set
    2. `squadId` is not set
...
CreateTelnyxPhoneNumberDtoFallbackDestination = typing_extensions.Annotated[
    typing.Union[
        CreateTelnyxPhoneNumberDtoFallbackDestination_Number, CreateTelnyxPhoneNumberDtoFallbackDestination_Sip
    ],
