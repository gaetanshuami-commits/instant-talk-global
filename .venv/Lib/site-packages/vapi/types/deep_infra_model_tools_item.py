...
class DeepInfraModelToolsItem_ApiRequest(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_Bash(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_Code(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_Computer(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_Dtmf(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_EndCall(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_Function(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_GohighlevelContactCreate(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_GohighlevelContactGet(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_Handoff(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_Mcp(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_Query(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_SlackMessageSend(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_Sms(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_TextEditor(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_TransferCall(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_SipRequest(UncheckedBaseModel):
...
class DeepInfraModelToolsItem_Voicemail(UncheckedBaseModel):
...
DeepInfraModelToolsItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(DeepInfraModelToolsItem_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(DeepInfraModelToolsItem_Bash)
update_forward_refs(DeepInfraModelToolsItem_Code)
update_forward_refs(DeepInfraModelToolsItem_Computer)
update_forward_refs(DeepInfraModelToolsItem_Dtmf)
update_forward_refs(DeepInfraModelToolsItem_EndCall)
update_forward_refs(DeepInfraModelToolsItem_Function)
update_forward_refs(DeepInfraModelToolsItem_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(DeepInfraModelToolsItem_GohighlevelCalendarEventCreate)
update_forward_refs(DeepInfraModelToolsItem_GohighlevelContactCreate)
update_forward_refs(DeepInfraModelToolsItem_GohighlevelContactGet)
update_forward_refs(DeepInfraModelToolsItem_GoogleCalendarAvailabilityCheck)
update_forward_refs(DeepInfraModelToolsItem_GoogleCalendarEventCreate)
update_forward_refs(DeepInfraModelToolsItem_GoogleSheetsRowAppend)
update_forward_refs(
    DeepInfraModelToolsItem_Handoff,
...
update_forward_refs(DeepInfraModelToolsItem_Mcp)
update_forward_refs(DeepInfraModelToolsItem_Query)
update_forward_refs(DeepInfraModelToolsItem_SlackMessageSend)
update_forward_refs(DeepInfraModelToolsItem_Sms)
update_forward_refs(DeepInfraModelToolsItem_TextEditor)
update_forward_refs(DeepInfraModelToolsItem_TransferCall)
update_forward_refs(DeepInfraModelToolsItem_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(DeepInfraModelToolsItem_Voicemail)
