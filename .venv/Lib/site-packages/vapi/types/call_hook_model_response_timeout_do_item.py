...
class CallHookModelResponseTimeoutDoItem_Say(UncheckedBaseModel):
...
class CallHookModelResponseTimeoutDoItem_Tool(UncheckedBaseModel):
...
class CallHookModelResponseTimeoutDoItem_MessageAdd(UncheckedBaseModel):
...
CallHookModelResponseTimeoutDoItem = typing_extensions.Annotated[
    typing.Union[
