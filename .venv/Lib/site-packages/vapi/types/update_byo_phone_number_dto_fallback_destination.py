...
class UpdateByoPhoneNumberDtoFallbackDestination_Number(UncheckedBaseModel):
    """
...
class UpdateByoPhoneNumberDtoFallbackDestination_Sip(UncheckedBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
    1. `assistantId` is not set
    2. `squadId` is not set
...
UpdateByoPhoneNumberDtoFallbackDestination = typing_extensions.Annotated[
    typing.Union[UpdateByoPhoneNumberDtoFallbackDestination_Number, UpdateByoPhoneNumberDtoFallbackDestination_Sip],
