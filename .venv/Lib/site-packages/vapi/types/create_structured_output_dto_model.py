...
class CreateStructuredOutputDtoModel_Openai(UncheckedBaseModel):
    """
...
class CreateStructuredOutputDtoModel_Anthropic(UncheckedBaseModel):
    """
    This is the model that will be used to extract the structured output.
...
class CreateStructuredOutputDtoModel_AnthropicBedrock(UncheckedBaseModel):
    """
    This is the model that will be used to extract the structured output.
...
class CreateStructuredOutputDtoModel_Google(UncheckedBaseModel):
    """
    This is the model that will be used to extract the structured output.
...
class CreateStructuredOutputDtoModel_CustomLlm(UncheckedBaseModel):
    """
    This is the model that will be used to extract the structured output.
...
CreateStructuredOutputDtoModel = typing_extensions.Annotated[
    typing.Union[
