...
class SimulationRunTarget_Assistant(UncheckedBaseModel):
    """
...
class SimulationRunTarget_Squad(UncheckedBaseModel):
    """
    Target to test against
    """
...
SimulationRunTarget = typing_extensions.Annotated[
    typing.Union[SimulationRunTarget_Assistant, SimulationRunTarget_Squad], UnionMetadata(discriminant="type")
]
