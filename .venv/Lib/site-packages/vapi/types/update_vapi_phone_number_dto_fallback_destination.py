...
class UpdateVapiPhoneNumberDtoFallbackDestination_Number(UncheckedBaseModel):
    """
...
class UpdateVapiPhoneNumberDtoFallbackDestination_Sip(UncheckedBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
    1. `assistantId` is not set
    2. `squadId` is not set
...
UpdateVapiPhoneNumberDtoFallbackDestination = typing_extensions.Annotated[
    typing.Union[UpdateVapiPhoneNumberDtoFallbackDestination_Number, UpdateVapiPhoneNumberDtoFallbackDestination_Sip],
