...
class ConversationNodeTranscriber_AssemblyAi(UncheckedBaseModel):
    """
...
class ConversationNodeTranscriber_Azure(UncheckedBaseModel):
    """
    This is the transcriber for the node.
...
class ConversationNodeTranscriber_CustomTranscriber(UncheckedBaseModel):
    """
    This is the transcriber for the node.
...
class ConversationNodeTranscriber_Deepgram(UncheckedBaseModel):
    """
    This is the transcriber for the node.
...
class ConversationNodeTranscriber_11Labs(UncheckedBaseModel):
    """
    This is the transcriber for the node.
...
class ConversationNodeTranscriber_Gladia(UncheckedBaseModel):
    """
    This is the transcriber for the node.
...
class ConversationNodeTranscriber_Google(UncheckedBaseModel):
    """
    This is the transcriber for the node.
...
class ConversationNodeTranscriber_Speechmatics(UncheckedBaseModel):
    """
    This is the transcriber for the node.
...
class ConversationNodeTranscriber_Talkscriber(UncheckedBaseModel):
    """
    This is the transcriber for the node.
...
class ConversationNodeTranscriber_Openai(UncheckedBaseModel):
    """
    This is the transcriber for the node.
...
class ConversationNodeTranscriber_Cartesia(UncheckedBaseModel):
    """
    This is the transcriber for the node.
...
class ConversationNodeTranscriber_Soniox(UncheckedBaseModel):
    """
    This is the transcriber for the node.
...
ConversationNodeTranscriber = typing_extensions.Annotated[
    typing.Union[
