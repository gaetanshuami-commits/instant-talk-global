...
class TransferCallToolMessagesItem_RequestStart(UncheckedBaseModel):
...
class TransferCallToolMessagesItem_RequestComplete(UncheckedBaseModel):
...
class TransferCallToolMessagesItem_RequestFailed(UncheckedBaseModel):
...
class TransferCallToolMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
TransferCallToolMessagesItem = typing_extensions.Annotated[
    typing.Union[
