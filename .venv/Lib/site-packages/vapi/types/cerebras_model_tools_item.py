...
class CerebrasModelToolsItem_ApiRequest(UncheckedBaseModel):
...
class CerebrasModelToolsItem_Bash(UncheckedBaseModel):
...
class CerebrasModelToolsItem_Code(UncheckedBaseModel):
...
class CerebrasModelToolsItem_Computer(UncheckedBaseModel):
...
class CerebrasModelToolsItem_Dtmf(UncheckedBaseModel):
...
class CerebrasModelToolsItem_EndCall(UncheckedBaseModel):
...
class CerebrasModelToolsItem_Function(UncheckedBaseModel):
...
class CerebrasModelToolsItem_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class CerebrasModelToolsItem_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class CerebrasModelToolsItem_GohighlevelContactCreate(UncheckedBaseModel):
...
class CerebrasModelToolsItem_GohighlevelContactGet(UncheckedBaseModel):
...
class CerebrasModelToolsItem_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class CerebrasModelToolsItem_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class CerebrasModelToolsItem_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class CerebrasModelToolsItem_Handoff(UncheckedBaseModel):
...
class CerebrasModelToolsItem_Mcp(UncheckedBaseModel):
...
class CerebrasModelToolsItem_Query(UncheckedBaseModel):
...
class CerebrasModelToolsItem_SlackMessageSend(UncheckedBaseModel):
...
class CerebrasModelToolsItem_Sms(UncheckedBaseModel):
...
class CerebrasModelToolsItem_TextEditor(UncheckedBaseModel):
...
class CerebrasModelToolsItem_TransferCall(UncheckedBaseModel):
...
class CerebrasModelToolsItem_SipRequest(UncheckedBaseModel):
...
class CerebrasModelToolsItem_Voicemail(UncheckedBaseModel):
...
CerebrasModelToolsItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(CerebrasModelToolsItem_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(CerebrasModelToolsItem_Bash)
update_forward_refs(CerebrasModelToolsItem_Code)
update_forward_refs(CerebrasModelToolsItem_Computer)
update_forward_refs(CerebrasModelToolsItem_Dtmf)
update_forward_refs(CerebrasModelToolsItem_EndCall)
update_forward_refs(CerebrasModelToolsItem_Function)
update_forward_refs(CerebrasModelToolsItem_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(CerebrasModelToolsItem_GohighlevelCalendarEventCreate)
update_forward_refs(CerebrasModelToolsItem_GohighlevelContactCreate)
update_forward_refs(CerebrasModelToolsItem_GohighlevelContactGet)
update_forward_refs(CerebrasModelToolsItem_GoogleCalendarAvailabilityCheck)
update_forward_refs(CerebrasModelToolsItem_GoogleCalendarEventCreate)
...
update_forward_refs(CerebrasModelToolsItem_Mcp)
update_forward_refs(CerebrasModelToolsItem_Query)
update_forward_refs(CerebrasModelToolsItem_SlackMessageSend)
update_forward_refs(CerebrasModelToolsItem_Sms)
update_forward_refs(CerebrasModelToolsItem_TextEditor)
update_forward_refs(CerebrasModelToolsItem_TransferCall)
update_forward_refs(CerebrasModelToolsItem_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(CerebrasModelToolsItem_Voicemail)
