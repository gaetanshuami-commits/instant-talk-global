...
class CreateFunctionToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class CreateFunctionToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class CreateFunctionToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class CreateFunctionToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
CreateFunctionToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
