...
class CreateOutputToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class CreateOutputToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class CreateOutputToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class CreateOutputToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
CreateOutputToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
