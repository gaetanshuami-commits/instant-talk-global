...
class UpdateTelnyxPhoneNumberDtoFallbackDestination_Number(UncheckedBaseModel):
    """
...
class UpdateTelnyxPhoneNumberDtoFallbackDestination_Sip(UncheckedBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
    1. `assistantId` is not set
    2. `squadId` is not set
...
UpdateTelnyxPhoneNumberDtoFallbackDestination = typing_extensions.Annotated[
    typing.Union[
