...
class UpdateVoicemailToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class UpdateVoicemailToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class UpdateVoicemailToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class UpdateVoicemailToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
UpdateVoicemailToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
