...
from .code_tool_messages_item import CodeToolMessagesItem
...
class CodeTool(UncheckedBaseModel):
    messages: typing.Optional[typing.List[CodeToolMessagesItem]] = pydantic.Field(default=None)
    """
