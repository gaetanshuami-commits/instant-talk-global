...
class CreateToolTemplateDtoDetails_ApiRequest(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_Bash(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_Code(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_Computer(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_Dtmf(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_EndCall(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_Function(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_GohighlevelContactCreate(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_GohighlevelContactGet(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_Handoff(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_Mcp(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_Query(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_SlackMessageSend(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_Sms(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_TextEditor(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_TransferCall(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_SipRequest(UncheckedBaseModel):
...
class CreateToolTemplateDtoDetails_Voicemail(UncheckedBaseModel):
...
CreateToolTemplateDtoDetails = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(CreateToolTemplateDtoDetails_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(CreateToolTemplateDtoDetails_Bash)
update_forward_refs(CreateToolTemplateDtoDetails_Code)
update_forward_refs(CreateToolTemplateDtoDetails_Computer)
update_forward_refs(CreateToolTemplateDtoDetails_Dtmf)
update_forward_refs(CreateToolTemplateDtoDetails_EndCall)
update_forward_refs(CreateToolTemplateDtoDetails_Function)
update_forward_refs(CreateToolTemplateDtoDetails_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(CreateToolTemplateDtoDetails_GohighlevelCalendarEventCreate)
update_forward_refs(CreateToolTemplateDtoDetails_GohighlevelContactCreate)
update_forward_refs(CreateToolTemplateDtoDetails_GohighlevelContactGet)
update_forward_refs(CreateToolTemplateDtoDetails_GoogleCalendarAvailabilityCheck)
update_forward_refs(CreateToolTemplateDtoDetails_GoogleCalendarEventCreate)
update_forward_refs(CreateToolTemplateDtoDetails_GoogleSheetsRowAppend)
update_forward_refs(
    CreateToolTemplateDtoDetails_Handoff,
...
update_forward_refs(CreateToolTemplateDtoDetails_Mcp)
update_forward_refs(CreateToolTemplateDtoDetails_Query)
update_forward_refs(CreateToolTemplateDtoDetails_SlackMessageSend)
update_forward_refs(CreateToolTemplateDtoDetails_Sms)
update_forward_refs(CreateToolTemplateDtoDetails_TextEditor)
update_forward_refs(CreateToolTemplateDtoDetails_TransferCall)
update_forward_refs(CreateToolTemplateDtoDetails_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(CreateToolTemplateDtoDetails_Voicemail)
