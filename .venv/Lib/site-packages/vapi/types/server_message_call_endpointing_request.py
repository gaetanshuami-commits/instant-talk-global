...
class ServerMessageCallEndpointingRequest(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ServerMessageCallEndpointingRequestPhoneNumber],
    ...
    messages_open_ai_formatted: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="messagesOpenAIFormatted", description="This is just `messages` formatted for OpenAI."),
    ]
