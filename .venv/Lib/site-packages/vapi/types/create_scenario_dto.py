...
from .create_scenario_dto_hooks_item import CreateScenarioDtoHooksItem
from .evaluation_plan_item import EvaluationPlanItem
from .scenario_tool_mock import ScenarioToolMock


class CreateScenarioDto(UncheckedBaseModel):
    ...
    hooks: typing.Optional[typing.List[CreateScenarioDtoHooksItem]] = pydantic.Field(default=None)
    """
