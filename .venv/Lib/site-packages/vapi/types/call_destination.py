...
class CallDestination_Number(UncheckedBaseModel):
    """
...
class CallDestination_Sip(UncheckedBaseModel):
    """
    This is the destination where the call ended up being transferred to. If the call was not transferred, this will be empty.
    """
...
CallDestination = typing_extensions.Annotated[
    typing.Union[CallDestination_Number, CallDestination_Sip], UnionMetadata(discriminant="type")
]
