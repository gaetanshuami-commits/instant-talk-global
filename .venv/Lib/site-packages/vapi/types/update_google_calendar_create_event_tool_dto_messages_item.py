...
class UpdateGoogleCalendarCreateEventToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class UpdateGoogleCalendarCreateEventToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class UpdateGoogleCalendarCreateEventToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class UpdateGoogleCalendarCreateEventToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
UpdateGoogleCalendarCreateEventToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
