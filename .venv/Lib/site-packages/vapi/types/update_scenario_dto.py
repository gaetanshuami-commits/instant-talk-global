...
from .update_scenario_dto_hooks_item import UpdateScenarioDtoHooksItem


class UpdateScenarioDto(UncheckedBaseModel):
    ...
    evaluations: typing.Optional[typing.List[EvaluationPlanItem]] = pydantic.Field(default=None)
    """
    ...
    hooks: typing.Optional[typing.List[UpdateScenarioDtoHooksItem]] = pydantic.Field(default=None)
    """
    ...
    tool_mocks: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="toolMocks"),
    ] = None
