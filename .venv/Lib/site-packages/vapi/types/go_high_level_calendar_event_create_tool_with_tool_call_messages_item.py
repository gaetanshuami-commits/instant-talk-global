...
class GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem_RequestStart(UncheckedBaseModel):
...
class GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem_RequestComplete(UncheckedBaseModel):
...
class GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem_RequestFailed(UncheckedBaseModel):
...
class GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem = typing_extensions.Annotated[
    typing.Union[
