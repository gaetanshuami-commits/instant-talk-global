...
class ServerMessageStatusUpdateDestination_Number(UncheckedBaseModel):
    """
...
class ServerMessageStatusUpdateDestination_Sip(UncheckedBaseModel):
    """
    This is the destination the call is being transferred to. This is only sent if the status is "forwarding".
    """
...
ServerMessageStatusUpdateDestination = typing_extensions.Annotated[
    typing.Union[ServerMessageStatusUpdateDestination_Number, ServerMessageStatusUpdateDestination_Sip],
