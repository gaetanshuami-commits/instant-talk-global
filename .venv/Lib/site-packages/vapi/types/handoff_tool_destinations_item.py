...
class HandoffToolDestinationsItem_Assistant(UncheckedBaseModel):
...
class HandoffToolDestinationsItem_Dynamic(UncheckedBaseModel):
...
class HandoffToolDestinationsItem_Squad(UncheckedBaseModel):
...
HandoffToolDestinationsItem = typing_extensions.Annotated[
    typing.Union[
        HandoffToolDestinationsItem_Assistant, HandoffToolDestinationsItem_Dynamic, HandoffToolDestinationsItem_Squad
    ],
