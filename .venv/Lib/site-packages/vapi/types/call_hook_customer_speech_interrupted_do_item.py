...
class CallHookCustomerSpeechInterruptedDoItem_Say(UncheckedBaseModel):
...
class CallHookCustomerSpeechInterruptedDoItem_Tool(UncheckedBaseModel):
...
class CallHookCustomerSpeechInterruptedDoItem_MessageAdd(UncheckedBaseModel):
...
CallHookCustomerSpeechInterruptedDoItem = typing_extensions.Annotated[
    typing.Union[
