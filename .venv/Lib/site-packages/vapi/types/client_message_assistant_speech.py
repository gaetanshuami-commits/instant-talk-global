...
from .client_message_assistant_speech_phone_number import ClientMessageAssistantSpeechPhoneNumber
from .client_message_assistant_speech_source import ClientMessageAssistantSpeechSource
from .client_message_assistant_speech_timing import ClientMessageAssistantSpeechTiming
from .client_message_assistant_speech_type import ClientMessageAssistantSpeechType
from .create_customer_dto import CreateCustomerDto


class ClientMessageAssistantSpeech(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ClientMessageAssistantSpeechPhoneNumber],
    ...
    type: ClientMessageAssistantSpeechType = pydantic.Field()
    """
    ...
    source: typing.Optional[ClientMessageAssistantSpeechSource] = pydantic.Field(default=None)
    """
    Indicates how the text was sourced.
    """

    timing: typing.Optional[ClientMessageAssistantSpeechTiming] = pydantic.Field(default=None)
    """
