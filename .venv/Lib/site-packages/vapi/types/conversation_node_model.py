...
class ConversationNodeModel_Openai(UncheckedBaseModel):
    """
...
class ConversationNodeModel_Anthropic(UncheckedBaseModel):
    """
    This is the model for the node.
...
class ConversationNodeModel_AnthropicBedrock(UncheckedBaseModel):
    """
    This is the model for the node.
...
class ConversationNodeModel_Google(UncheckedBaseModel):
    """
    This is the model for the node.
...
class ConversationNodeModel_CustomLlm(UncheckedBaseModel):
    """
    This is the model for the node.
...
ConversationNodeModel = typing_extensions.Annotated[
    typing.Union[
