...
class WorkflowUserEditableModel_Anthropic(UncheckedBaseModel):
    """
    This is the model for the workflow.
...
class WorkflowUserEditableModel_AnthropicBedrock(UncheckedBaseModel):
    """
    This is the model for the workflow.
...
class WorkflowUserEditableModel_Google(UncheckedBaseModel):
    """
    This is the model for the workflow.
...
class WorkflowUserEditableModel_CustomLlm(UncheckedBaseModel):
    """
    This is the model for the workflow.
...
WorkflowUserEditableModel = typing_extensions.Annotated[
    typing.Union[
