...
class AssistantOverrides(UncheckedBaseModel):
    ...
    voicemail_detection: typing_extensions.Annotated[
        typing.Optional[AssistantOverridesVoicemailDetection],
    ...
    client_messages: typing_extensions.Annotated[
        typing.Optional[typing.List[AssistantOverridesClientMessagesItem]],
    ...
    server_messages: typing_extensions.Annotated[
        typing.Optional[typing.List[AssistantOverridesServerMessagesItem]],
    ...
    background_sound: typing_extensions.Annotated[
        typing.Optional[AssistantOverridesBackgroundSound],
