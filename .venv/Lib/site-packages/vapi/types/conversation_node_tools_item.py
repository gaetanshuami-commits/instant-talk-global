...
class ConversationNodeToolsItem_ApiRequest(UncheckedBaseModel):
...
class ConversationNodeToolsItem_Bash(UncheckedBaseModel):
...
class ConversationNodeToolsItem_Code(UncheckedBaseModel):
...
class ConversationNodeToolsItem_Computer(UncheckedBaseModel):
...
class ConversationNodeToolsItem_Dtmf(UncheckedBaseModel):
...
class ConversationNodeToolsItem_EndCall(UncheckedBaseModel):
...
class ConversationNodeToolsItem_Function(UncheckedBaseModel):
...
class ConversationNodeToolsItem_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class ConversationNodeToolsItem_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class ConversationNodeToolsItem_GohighlevelContactCreate(UncheckedBaseModel):
...
class ConversationNodeToolsItem_GohighlevelContactGet(UncheckedBaseModel):
...
class ConversationNodeToolsItem_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class ConversationNodeToolsItem_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class ConversationNodeToolsItem_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class ConversationNodeToolsItem_Handoff(UncheckedBaseModel):
...
class ConversationNodeToolsItem_Mcp(UncheckedBaseModel):
...
class ConversationNodeToolsItem_Query(UncheckedBaseModel):
...
class ConversationNodeToolsItem_SlackMessageSend(UncheckedBaseModel):
...
class ConversationNodeToolsItem_Sms(UncheckedBaseModel):
...
class ConversationNodeToolsItem_TextEditor(UncheckedBaseModel):
...
class ConversationNodeToolsItem_TransferCall(UncheckedBaseModel):
...
class ConversationNodeToolsItem_SipRequest(UncheckedBaseModel):
...
class ConversationNodeToolsItem_Voicemail(UncheckedBaseModel):
...
ConversationNodeToolsItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(ConversationNodeToolsItem_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(ConversationNodeToolsItem_Bash)
update_forward_refs(ConversationNodeToolsItem_Code)
update_forward_refs(ConversationNodeToolsItem_Computer)
update_forward_refs(ConversationNodeToolsItem_Dtmf)
update_forward_refs(ConversationNodeToolsItem_EndCall)
update_forward_refs(ConversationNodeToolsItem_Function)
update_forward_refs(ConversationNodeToolsItem_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(ConversationNodeToolsItem_GohighlevelCalendarEventCreate)
update_forward_refs(ConversationNodeToolsItem_GohighlevelContactCreate)
update_forward_refs(ConversationNodeToolsItem_GohighlevelContactGet)
update_forward_refs(ConversationNodeToolsItem_GoogleCalendarAvailabilityCheck)
update_forward_refs(ConversationNodeToolsItem_GoogleCalendarEventCreate)
update_forward_refs(ConversationNodeToolsItem_GoogleSheetsRowAppend)
update_forward_refs(
    ConversationNodeToolsItem_Handoff,
...
update_forward_refs(ConversationNodeToolsItem_Mcp)
update_forward_refs(ConversationNodeToolsItem_Query)
update_forward_refs(ConversationNodeToolsItem_SlackMessageSend)
update_forward_refs(ConversationNodeToolsItem_Sms)
update_forward_refs(ConversationNodeToolsItem_TextEditor)
update_forward_refs(ConversationNodeToolsItem_TransferCall)
update_forward_refs(ConversationNodeToolsItem_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(ConversationNodeToolsItem_Voicemail)
