...
class CreateEndCallToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class CreateEndCallToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class CreateEndCallToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class CreateEndCallToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
CreateEndCallToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
