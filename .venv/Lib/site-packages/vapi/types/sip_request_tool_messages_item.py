...
class SipRequestToolMessagesItem_RequestStart(UncheckedBaseModel):
...
class SipRequestToolMessagesItem_RequestComplete(UncheckedBaseModel):
...
class SipRequestToolMessagesItem_RequestFailed(UncheckedBaseModel):
...
class SipRequestToolMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
SipRequestToolMessagesItem = typing_extensions.Annotated[
    typing.Union[
