...
class ImportTwilioPhoneNumberDtoFallbackDestination_Number(UncheckedBaseModel):
    """
...
class ImportTwilioPhoneNumberDtoFallbackDestination_Sip(UncheckedBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
    1. `assistantId` is not set
    2. `squadId` is not set
...
ImportTwilioPhoneNumberDtoFallbackDestination = typing_extensions.Annotated[
    typing.Union[
        ImportTwilioPhoneNumberDtoFallbackDestination_Number, ImportTwilioPhoneNumberDtoFallbackDestination_Sip
    ],
