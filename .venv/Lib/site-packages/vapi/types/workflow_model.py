...
class WorkflowModel_Openai(UncheckedBaseModel):
    """
...
class WorkflowModel_Anthropic(UncheckedBaseModel):
    """
    This is the model for the workflow.
...
class WorkflowModel_AnthropicBedrock(UncheckedBaseModel):
    """
    This is the model for the workflow.
...
class WorkflowModel_Google(UncheckedBaseModel):
    """
    This is the model for the workflow.
...
class WorkflowModel_CustomLlm(UncheckedBaseModel):
    """
    This is the model for the workflow.
...
WorkflowModel = typing_extensions.Annotated[
    typing.Union[
