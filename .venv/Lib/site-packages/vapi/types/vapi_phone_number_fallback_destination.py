...
class VapiPhoneNumberFallbackDestination_Number(UncheckedBaseModel):
    """
...
class VapiPhoneNumberFallbackDestination_Sip(UncheckedBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
    1. `assistantId` is not set
    2. `squadId` is not set
...
VapiPhoneNumberFallbackDestination = typing_extensions.Annotated[
    typing.Union[VapiPhoneNumberFallbackDestination_Number, VapiPhoneNumberFallbackDestination_Sip],
