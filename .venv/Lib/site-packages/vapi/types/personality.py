...
class Personality(UncheckedBaseModel):
    ...
    created_at: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="createdAt", description="This is the ISO 8601 date-time string of when the personality was created."
        ),
    ]
    ...
    assistant: "CreateAssistantDto" = pydantic.Field()
    """
