...
class GoHighLevelContactCreateToolWithToolCallMessagesItem_RequestStart(UncheckedBaseModel):
...
class GoHighLevelContactCreateToolWithToolCallMessagesItem_RequestComplete(UncheckedBaseModel):
...
class GoHighLevelContactCreateToolWithToolCallMessagesItem_RequestFailed(UncheckedBaseModel):
...
class GoHighLevelContactCreateToolWithToolCallMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
GoHighLevelContactCreateToolWithToolCallMessagesItem = typing_extensions.Annotated[
    typing.Union[
