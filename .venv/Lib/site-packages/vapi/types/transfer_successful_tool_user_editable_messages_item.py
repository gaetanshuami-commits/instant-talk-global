...
class TransferSuccessfulToolUserEditableMessagesItem_RequestStart(UncheckedBaseModel):
...
class TransferSuccessfulToolUserEditableMessagesItem_RequestComplete(UncheckedBaseModel):
...
class TransferSuccessfulToolUserEditableMessagesItem_RequestFailed(UncheckedBaseModel):
...
class TransferSuccessfulToolUserEditableMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
TransferSuccessfulToolUserEditableMessagesItem = typing_extensions.Annotated[
    typing.Union[
