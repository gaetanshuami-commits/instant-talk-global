...
class GoogleCalendarCreateEventToolWithToolCallMessagesItem_RequestStart(UncheckedBaseModel):
...
class GoogleCalendarCreateEventToolWithToolCallMessagesItem_RequestComplete(UncheckedBaseModel):
...
class GoogleCalendarCreateEventToolWithToolCallMessagesItem_RequestFailed(UncheckedBaseModel):
...
class GoogleCalendarCreateEventToolWithToolCallMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
GoogleCalendarCreateEventToolWithToolCallMessagesItem = typing_extensions.Annotated[
    typing.Union[
