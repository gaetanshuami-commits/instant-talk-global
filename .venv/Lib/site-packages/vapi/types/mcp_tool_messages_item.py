...
class McpToolMessagesItem_RequestStart(UncheckedBaseModel):
...
class McpToolMessagesItem_RequestComplete(UncheckedBaseModel):
...
class McpToolMessagesItem_RequestFailed(UncheckedBaseModel):
...
class McpToolMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
McpToolMessagesItem = typing_extensions.Annotated[
    typing.Union[
