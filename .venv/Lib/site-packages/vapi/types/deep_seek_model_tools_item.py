...
class DeepSeekModelToolsItem_ApiRequest(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_Bash(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_Code(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_Computer(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_Dtmf(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_EndCall(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_Function(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_GohighlevelContactCreate(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_GohighlevelContactGet(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_Handoff(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_Mcp(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_Query(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_SlackMessageSend(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_Sms(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_TextEditor(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_TransferCall(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_SipRequest(UncheckedBaseModel):
...
class DeepSeekModelToolsItem_Voicemail(UncheckedBaseModel):
...
DeepSeekModelToolsItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(DeepSeekModelToolsItem_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(DeepSeekModelToolsItem_Bash)
update_forward_refs(DeepSeekModelToolsItem_Code)
update_forward_refs(DeepSeekModelToolsItem_Computer)
update_forward_refs(DeepSeekModelToolsItem_Dtmf)
update_forward_refs(DeepSeekModelToolsItem_EndCall)
update_forward_refs(DeepSeekModelToolsItem_Function)
update_forward_refs(DeepSeekModelToolsItem_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(DeepSeekModelToolsItem_GohighlevelCalendarEventCreate)
update_forward_refs(DeepSeekModelToolsItem_GohighlevelContactCreate)
update_forward_refs(DeepSeekModelToolsItem_GohighlevelContactGet)
update_forward_refs(DeepSeekModelToolsItem_GoogleCalendarAvailabilityCheck)
update_forward_refs(DeepSeekModelToolsItem_GoogleCalendarEventCreate)
update_forward_refs(DeepSeekModelToolsItem_GoogleSheetsRowAppend)
update_forward_refs(
    DeepSeekModelToolsItem_Handoff,
...
update_forward_refs(DeepSeekModelToolsItem_Mcp)
update_forward_refs(DeepSeekModelToolsItem_Query)
update_forward_refs(DeepSeekModelToolsItem_SlackMessageSend)
update_forward_refs(DeepSeekModelToolsItem_Sms)
update_forward_refs(DeepSeekModelToolsItem_TextEditor)
update_forward_refs(DeepSeekModelToolsItem_TransferCall)
update_forward_refs(DeepSeekModelToolsItem_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(DeepSeekModelToolsItem_Voicemail)
