...
class CodeToolMessagesItem_RequestStart(UncheckedBaseModel):
...
class CodeToolMessagesItem_RequestComplete(UncheckedBaseModel):
...
class CodeToolMessagesItem_RequestFailed(UncheckedBaseModel):
...
class CodeToolMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
CodeToolMessagesItem = typing_extensions.Annotated[
    typing.Union[
