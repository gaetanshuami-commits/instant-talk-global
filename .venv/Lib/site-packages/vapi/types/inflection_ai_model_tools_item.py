...
class InflectionAiModelToolsItem_ApiRequest(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_Bash(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_Code(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_Computer(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_Dtmf(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_EndCall(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_Function(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_GohighlevelContactCreate(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_GohighlevelContactGet(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_Handoff(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_Mcp(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_Query(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_SlackMessageSend(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_Sms(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_TextEditor(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_TransferCall(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_SipRequest(UncheckedBaseModel):
...
class InflectionAiModelToolsItem_Voicemail(UncheckedBaseModel):
...
InflectionAiModelToolsItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(InflectionAiModelToolsItem_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(InflectionAiModelToolsItem_Bash)
update_forward_refs(InflectionAiModelToolsItem_Code)
update_forward_refs(InflectionAiModelToolsItem_Computer)
update_forward_refs(InflectionAiModelToolsItem_Dtmf)
update_forward_refs(InflectionAiModelToolsItem_EndCall)
update_forward_refs(InflectionAiModelToolsItem_Function)
update_forward_refs(InflectionAiModelToolsItem_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(InflectionAiModelToolsItem_GohighlevelCalendarEventCreate)
update_forward_refs(InflectionAiModelToolsItem_GohighlevelContactCreate)
update_forward_refs(InflectionAiModelToolsItem_GohighlevelContactGet)
update_forward_refs(InflectionAiModelToolsItem_GoogleCalendarAvailabilityCheck)
update_forward_refs(InflectionAiModelToolsItem_GoogleCalendarEventCreate)
update_forward_refs(InflectionAiModelToolsItem_GoogleSheetsRowAppend)
update_forward_refs(
    InflectionAiModelToolsItem_Handoff,
...
update_forward_refs(InflectionAiModelToolsItem_Mcp)
update_forward_refs(InflectionAiModelToolsItem_Query)
update_forward_refs(InflectionAiModelToolsItem_SlackMessageSend)
update_forward_refs(InflectionAiModelToolsItem_Sms)
update_forward_refs(InflectionAiModelToolsItem_TextEditor)
update_forward_refs(InflectionAiModelToolsItem_TransferCall)
update_forward_refs(InflectionAiModelToolsItem_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(InflectionAiModelToolsItem_Voicemail)
