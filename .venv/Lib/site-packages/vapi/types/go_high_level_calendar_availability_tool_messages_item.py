...
class GoHighLevelCalendarAvailabilityToolMessagesItem_RequestStart(UncheckedBaseModel):
...
class GoHighLevelCalendarAvailabilityToolMessagesItem_RequestComplete(UncheckedBaseModel):
...
class GoHighLevelCalendarAvailabilityToolMessagesItem_RequestFailed(UncheckedBaseModel):
...
class GoHighLevelCalendarAvailabilityToolMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
GoHighLevelCalendarAvailabilityToolMessagesItem = typing_extensions.Annotated[
    typing.Union[
