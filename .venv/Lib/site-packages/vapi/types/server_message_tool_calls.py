...
class ServerMessageToolCalls(UncheckedBaseModel):
    phone_number: typing_extensions.Annotated[
        typing.Optional[ServerMessageToolCallsPhoneNumber],
    ...
    tool_with_tool_call_list: typing_extensions.Annotated[
        typing.List[ServerMessageToolCallsToolWithToolCallListItem],
        FieldMetadata(alias="toolWithToolCallList"),
        pydantic.Field(
    ...
    tool_call_list: typing_extensions.Annotated[
        typing.List[ToolCall],
        FieldMetadata(alias="toolCallList"),
        pydantic.Field(
            alias="toolCallList", description="This is the list of tool calls that the model is requesting."
        ),
    ]
