...
class FunctionCallHookActionMessagesItem_RequestStart(UncheckedBaseModel):
...
class FunctionCallHookActionMessagesItem_RequestComplete(UncheckedBaseModel):
...
class FunctionCallHookActionMessagesItem_RequestFailed(UncheckedBaseModel):
...
class FunctionCallHookActionMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
FunctionCallHookActionMessagesItem = typing_extensions.Annotated[
    typing.Union[
