...
class AnthropicModelToolsItem_ApiRequest(UncheckedBaseModel):
...
class AnthropicModelToolsItem_Bash(UncheckedBaseModel):
...
class AnthropicModelToolsItem_Code(UncheckedBaseModel):
...
class AnthropicModelToolsItem_Computer(UncheckedBaseModel):
...
class AnthropicModelToolsItem_Dtmf(UncheckedBaseModel):
...
class AnthropicModelToolsItem_EndCall(UncheckedBaseModel):
...
class AnthropicModelToolsItem_Function(UncheckedBaseModel):
...
class AnthropicModelToolsItem_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class AnthropicModelToolsItem_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class AnthropicModelToolsItem_GohighlevelContactCreate(UncheckedBaseModel):
...
class AnthropicModelToolsItem_GohighlevelContactGet(UncheckedBaseModel):
...
class AnthropicModelToolsItem_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class AnthropicModelToolsItem_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class AnthropicModelToolsItem_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class AnthropicModelToolsItem_Handoff(UncheckedBaseModel):
...
class AnthropicModelToolsItem_Mcp(UncheckedBaseModel):
...
class AnthropicModelToolsItem_Query(UncheckedBaseModel):
...
class AnthropicModelToolsItem_SlackMessageSend(UncheckedBaseModel):
...
class AnthropicModelToolsItem_Sms(UncheckedBaseModel):
...
class AnthropicModelToolsItem_TextEditor(UncheckedBaseModel):
...
class AnthropicModelToolsItem_TransferCall(UncheckedBaseModel):
...
class AnthropicModelToolsItem_SipRequest(UncheckedBaseModel):
...
class AnthropicModelToolsItem_Voicemail(UncheckedBaseModel):
...
AnthropicModelToolsItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(AnthropicModelToolsItem_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(AnthropicModelToolsItem_Bash)
update_forward_refs(AnthropicModelToolsItem_Code)
update_forward_refs(AnthropicModelToolsItem_Computer)
update_forward_refs(AnthropicModelToolsItem_Dtmf)
update_forward_refs(AnthropicModelToolsItem_EndCall)
update_forward_refs(AnthropicModelToolsItem_Function)
update_forward_refs(AnthropicModelToolsItem_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(AnthropicModelToolsItem_GohighlevelCalendarEventCreate)
update_forward_refs(AnthropicModelToolsItem_GohighlevelContactCreate)
update_forward_refs(AnthropicModelToolsItem_GohighlevelContactGet)
update_forward_refs(AnthropicModelToolsItem_GoogleCalendarAvailabilityCheck)
update_forward_refs(AnthropicModelToolsItem_GoogleCalendarEventCreate)
update_forward_refs(AnthropicModelToolsItem_GoogleSheetsRowAppend)
update_forward_refs(
    AnthropicModelToolsItem_Handoff,
...
update_forward_refs(AnthropicModelToolsItem_Mcp)
update_forward_refs(AnthropicModelToolsItem_Query)
update_forward_refs(AnthropicModelToolsItem_SlackMessageSend)
update_forward_refs(AnthropicModelToolsItem_Sms)
update_forward_refs(AnthropicModelToolsItem_TextEditor)
update_forward_refs(AnthropicModelToolsItem_TransferCall)
update_forward_refs(AnthropicModelToolsItem_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(AnthropicModelToolsItem_Voicemail)
