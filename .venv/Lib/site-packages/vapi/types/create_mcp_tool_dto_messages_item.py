...
class CreateMcpToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class CreateMcpToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class CreateMcpToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class CreateMcpToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
CreateMcpToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
