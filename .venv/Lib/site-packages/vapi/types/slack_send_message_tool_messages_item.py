...
class SlackSendMessageToolMessagesItem_RequestStart(UncheckedBaseModel):
...
class SlackSendMessageToolMessagesItem_RequestComplete(UncheckedBaseModel):
...
class SlackSendMessageToolMessagesItem_RequestFailed(UncheckedBaseModel):
...
class SlackSendMessageToolMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
SlackSendMessageToolMessagesItem = typing_extensions.Annotated[
    typing.Union[
