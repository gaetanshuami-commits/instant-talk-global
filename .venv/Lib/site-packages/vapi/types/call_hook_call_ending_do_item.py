...
class CallHookCallEndingDoItem_Tool(UncheckedBaseModel):
...
class CallHookCallEndingDoItem_MessageAdd(UncheckedBaseModel):
...
CallHookCallEndingDoItem = typing_extensions.Annotated[
    typing.Union[CallHookCallEndingDoItem_Tool, CallHookCallEndingDoItem_MessageAdd], UnionMetadata(discriminant="type")
]
