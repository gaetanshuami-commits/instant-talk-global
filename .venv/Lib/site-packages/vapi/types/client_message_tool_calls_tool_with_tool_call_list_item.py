...
class ClientMessageToolCallsToolWithToolCallListItem_Function(UncheckedBaseModel):
...
class ClientMessageToolCallsToolWithToolCallListItem_Ghl(UncheckedBaseModel):
...
class ClientMessageToolCallsToolWithToolCallListItem_Make(UncheckedBaseModel):
...
class ClientMessageToolCallsToolWithToolCallListItem_Bash(UncheckedBaseModel):
...
class ClientMessageToolCallsToolWithToolCallListItem_Computer(UncheckedBaseModel):
...
class ClientMessageToolCallsToolWithToolCallListItem_TextEditor(UncheckedBaseModel):
...
class ClientMessageToolCallsToolWithToolCallListItem_GoogleCalendarEventCreate(UncheckedBaseModel):
...
ClientMessageToolCallsToolWithToolCallListItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(ClientMessageToolCallsToolWithToolCallListItem_Function)
update_forward_refs(ClientMessageToolCallsToolWithToolCallListItem_Ghl)
update_forward_refs(ClientMessageToolCallsToolWithToolCallListItem_Make)
