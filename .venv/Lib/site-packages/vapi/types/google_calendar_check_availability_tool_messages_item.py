...
class GoogleCalendarCheckAvailabilityToolMessagesItem_RequestStart(UncheckedBaseModel):
...
class GoogleCalendarCheckAvailabilityToolMessagesItem_RequestComplete(UncheckedBaseModel):
...
class GoogleCalendarCheckAvailabilityToolMessagesItem_RequestFailed(UncheckedBaseModel):
...
class GoogleCalendarCheckAvailabilityToolMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
GoogleCalendarCheckAvailabilityToolMessagesItem = typing_extensions.Annotated[
    typing.Union[
