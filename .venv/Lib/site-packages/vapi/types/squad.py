...
class Squad(UncheckedBaseModel):
    ...
    members_overrides: typing_extensions.Annotated[
        ...
        FieldMetadata(alias="membersOverrides"),
        pydantic.Field(
            alias="membersOverrides",
    ...
    org_id: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="orgId", description="This is the unique identifier for the org that this squad belongs to."
        ),
    ]
    created_at: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="createdAt", description="This is the ISO 8601 date-time string of when the squad was created."
        ),
    ]
    updated_at: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="updatedAt", description="This is the ISO 8601 date-time string of when the squad was last updated."
        ),
    ]
