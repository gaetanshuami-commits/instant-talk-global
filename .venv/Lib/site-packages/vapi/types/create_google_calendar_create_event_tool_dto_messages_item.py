...
class CreateGoogleCalendarCreateEventToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class CreateGoogleCalendarCreateEventToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class CreateGoogleCalendarCreateEventToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class CreateGoogleCalendarCreateEventToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
CreateGoogleCalendarCreateEventToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
