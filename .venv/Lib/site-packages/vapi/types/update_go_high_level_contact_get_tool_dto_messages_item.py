...
class UpdateGoHighLevelContactGetToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class UpdateGoHighLevelContactGetToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class UpdateGoHighLevelContactGetToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class UpdateGoHighLevelContactGetToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
UpdateGoHighLevelContactGetToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
