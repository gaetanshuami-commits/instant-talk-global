...
class UpdateDtmfToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class UpdateDtmfToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class UpdateDtmfToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class UpdateDtmfToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
UpdateDtmfToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
