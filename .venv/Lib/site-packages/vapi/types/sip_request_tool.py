...
from .sip_request_tool_messages_item import SipRequestToolMessagesItem
...
class SipRequestTool(UncheckedBaseModel):
    messages: typing.Optional[typing.List[SipRequestToolMessagesItem]] = pydantic.Field(default=None)
    """
    ...
    verb: SipRequestToolVerb = pydantic.Field()
    """
    ...
    body: typing.Optional[SipRequestToolBody] = pydantic.Field(default=None)
    """
...
update_forward_refs(SipRequestTool, JsonSchema=JsonSchema)
