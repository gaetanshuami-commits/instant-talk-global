...
class TwilioPhoneNumberFallbackDestination_Number(UncheckedBaseModel):
    """
...
class TwilioPhoneNumberFallbackDestination_Sip(UncheckedBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
    1. `assistantId` is not set
    2. `squadId` is not set
...
TwilioPhoneNumberFallbackDestination = typing_extensions.Annotated[
    typing.Union[TwilioPhoneNumberFallbackDestination_Number, TwilioPhoneNumberFallbackDestination_Sip],
