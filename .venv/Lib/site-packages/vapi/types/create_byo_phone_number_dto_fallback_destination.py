...
class CreateByoPhoneNumberDtoFallbackDestination_Number(UncheckedBaseModel):
    """
...
class CreateByoPhoneNumberDtoFallbackDestination_Sip(UncheckedBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
    1. `assistantId` is not set
    2. `squadId` is not set
...
CreateByoPhoneNumberDtoFallbackDestination = typing_extensions.Annotated[
    typing.Union[CreateByoPhoneNumberDtoFallbackDestination_Number, CreateByoPhoneNumberDtoFallbackDestination_Sip],
