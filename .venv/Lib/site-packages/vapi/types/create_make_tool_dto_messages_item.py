...
class CreateMakeToolDtoMessagesItem_RequestStart(UncheckedBaseModel):
...
class CreateMakeToolDtoMessagesItem_RequestComplete(UncheckedBaseModel):
...
class CreateMakeToolDtoMessagesItem_RequestFailed(UncheckedBaseModel):
...
class CreateMakeToolDtoMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
CreateMakeToolDtoMessagesItem = typing_extensions.Annotated[
    typing.Union[
