...
class ImportVonagePhoneNumberDtoFallbackDestination_Number(UncheckedBaseModel):
    """
...
class ImportVonagePhoneNumberDtoFallbackDestination_Sip(UncheckedBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
    1. `assistantId` is not set
    2. `squadId` is not set
...
ImportVonagePhoneNumberDtoFallbackDestination = typing_extensions.Annotated[
    typing.Union[
        ImportVonagePhoneNumberDtoFallbackDestination_Number, ImportVonagePhoneNumberDtoFallbackDestination_Sip
    ],
