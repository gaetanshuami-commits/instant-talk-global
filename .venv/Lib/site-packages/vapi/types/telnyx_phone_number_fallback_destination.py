...
class TelnyxPhoneNumberFallbackDestination_Number(UncheckedBaseModel):
    """
...
class TelnyxPhoneNumberFallbackDestination_Sip(UncheckedBaseModel):
    """
    This is the fallback destination an inbound call will be transferred to if:
    1. `assistantId` is not set
    2. `squadId` is not set
...
TelnyxPhoneNumberFallbackDestination = typing_extensions.Annotated[
    typing.Union[TelnyxPhoneNumberFallbackDestination_Number, TelnyxPhoneNumberFallbackDestination_Sip],
