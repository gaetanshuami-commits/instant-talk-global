...
class AssistantOverridesToolsAppendItem_ApiRequest(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_Bash(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_Code(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_Computer(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_Dtmf(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_EndCall(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_Function(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_GohighlevelCalendarAvailabilityCheck(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_GohighlevelCalendarEventCreate(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_GohighlevelContactCreate(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_GohighlevelContactGet(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_GoogleCalendarAvailabilityCheck(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_GoogleCalendarEventCreate(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_GoogleSheetsRowAppend(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_Handoff(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_Mcp(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_Query(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_SlackMessageSend(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_Sms(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_TextEditor(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_TransferCall(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_SipRequest(UncheckedBaseModel):
...
class AssistantOverridesToolsAppendItem_Voicemail(UncheckedBaseModel):
...
AssistantOverridesToolsAppendItem = typing_extensions.Annotated[
    typing.Union[
...
update_forward_refs(AssistantOverridesToolsAppendItem_ApiRequest, JsonSchema=JsonSchema)
update_forward_refs(AssistantOverridesToolsAppendItem_Bash)
update_forward_refs(AssistantOverridesToolsAppendItem_Code)
update_forward_refs(AssistantOverridesToolsAppendItem_Computer)
update_forward_refs(AssistantOverridesToolsAppendItem_Dtmf)
update_forward_refs(AssistantOverridesToolsAppendItem_EndCall)
update_forward_refs(AssistantOverridesToolsAppendItem_Function)
update_forward_refs(AssistantOverridesToolsAppendItem_GohighlevelCalendarAvailabilityCheck)
update_forward_refs(AssistantOverridesToolsAppendItem_GohighlevelCalendarEventCreate)
...
update_forward_refs(AssistantOverridesToolsAppendItem_GoogleCalendarAvailabilityCheck)
update_forward_refs(AssistantOverridesToolsAppendItem_GoogleCalendarEventCreate)
update_forward_refs(AssistantOverridesToolsAppendItem_GoogleSheetsRowAppend)
update_forward_refs(
    AssistantOverridesToolsAppendItem_Handoff,
...
update_forward_refs(AssistantOverridesToolsAppendItem_Mcp)
update_forward_refs(AssistantOverridesToolsAppendItem_Query)
update_forward_refs(AssistantOverridesToolsAppendItem_SlackMessageSend)
update_forward_refs(AssistantOverridesToolsAppendItem_Sms)
update_forward_refs(AssistantOverridesToolsAppendItem_TextEditor)
update_forward_refs(AssistantOverridesToolsAppendItem_TransferCall)
update_forward_refs(AssistantOverridesToolsAppendItem_SipRequest, JsonSchema=JsonSchema)
update_forward_refs(AssistantOverridesToolsAppendItem_Voicemail)
