...
class QueryToolMessagesItem_RequestStart(UncheckedBaseModel):
...
class QueryToolMessagesItem_RequestComplete(UncheckedBaseModel):
...
class QueryToolMessagesItem_RequestFailed(UncheckedBaseModel):
...
class QueryToolMessagesItem_RequestResponseDelayed(UncheckedBaseModel):
...
QueryToolMessagesItem = typing_extensions.Annotated[
    typing.Union[
